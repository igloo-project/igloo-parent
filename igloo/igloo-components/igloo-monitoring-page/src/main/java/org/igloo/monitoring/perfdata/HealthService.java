...
public class HealthService implements IHealthService {
	...
	public HealthLookup getHealthLookup(String metric) {
		return Optional.ofNullable(services.get(metric)).map(IHealthMetricService::getHealthLookup).orElseThrow();
	}
	...
	public static HealthService of(@Nonnull String name, @Nonnull IHealthMetricService service, Object... args) {
