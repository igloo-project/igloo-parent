...
/**
 * This {@link MonitoringResource} is made to be used with a spring context providing a unique
 * {@link IHealthService}. Metrics is looked up by {@code metricName} provided in constructor.
 */
public class SpringBackedMonitoringResource extends MonitoringResource {
  ...
  public static final ResourceReference get(String name) {
    return new ResourceReference(SpringBackedMonitoringResource.class, "name") {
  ...
  @SpringBean private IHealthService healthService;
