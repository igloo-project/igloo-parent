...
public class Utils {
	...
	public static IResourceStream findResourceStream(final MarkupContainer container, final Class<?> originalContainerClass) {
		...
		throw new IllegalStateException(String.format("Markup cannot be found for %s", originalContainerClass));
	}
