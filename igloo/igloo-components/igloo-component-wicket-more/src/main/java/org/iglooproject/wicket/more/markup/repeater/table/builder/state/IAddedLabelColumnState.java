...
public interface IAddedLabelColumnState<T, S extends ISort<?>> extends IAddedCoreColumnState<T, S> {
  ...
  <C> IAddedLabelColumnState<T, S> withTooltip(
      SerializableFunction2<? super T, C> function, Renderer<? super C> renderer);
  ...
  <C> IAddedLabelColumnState<T, S> withLink(
      SerializableFunction2<? super T, C> binding,
  ...
  <C> IAddedLabelColumnState<T, S> withSideLink(
      SerializableFunction2<? super T, C> binding,
      ILinkDescriptorMapper<? extends ILinkGenerator, ? super IModel<C>> linkGeneratorMapper);
