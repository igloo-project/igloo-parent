...
public interface IAddedBootstrapBadgeColumnState<T, S extends ISort<?>, C>
  ...
  @Override
  IAddedBootstrapBadgeColumnState<T, S, C> withSort(
      S sort, ISortIconStyle sortIconStyle, CycleMode cycleMode);
  ...
  <E> IAddedBootstrapBadgeColumnState<T, S, C> withLink(
      SerializableFunction2<? super T, E> binding,
  ...
  <E> IAddedBootstrapBadgeColumnState<T, S, C> withSideLink(
      SerializableFunction2<? super T, E> binding,
      ILinkDescriptorMapper<? extends ILinkGenerator, ? super IModel<E>> linkGeneratorMapper);
