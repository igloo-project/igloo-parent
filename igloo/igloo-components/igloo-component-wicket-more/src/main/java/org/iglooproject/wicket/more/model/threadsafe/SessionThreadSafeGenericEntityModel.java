...
/**
 * An alternative implementation of {@link GenericEntityModel} that is thread-safe, and may thus be
 * used in multiple request cycles at the same time.
 *
 * <p>This class should be used when entity models are needed in a global object, such as the {@link
 * Session wicket session}.
 *
 * @see SessionThreadSafeDerivedSerializableStateLoadableDetachableModel
 */
public class SessionThreadSafeGenericEntityModel<
    ...
    extends SessionThreadSafeDerivedSerializableStateLoadableDetachableModel<
        E, SessionThreadSafeGenericEntityModel.SerializableState<K, E>> {
  ...
  protected E load(SerializableState<K, E> serializableState) {
    ...
    GenericEntityReference<K, E> persistedEntityReference =
        serializableState.persistedEntityReference;
  ...
  protected static class SerializableState<
          K extends Serializable & Comparable<K>, E extends GenericEntity<K, ?>>
