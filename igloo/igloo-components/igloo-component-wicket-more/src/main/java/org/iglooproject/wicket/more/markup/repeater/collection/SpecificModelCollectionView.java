 ...
 */
public abstract class SpecificModelCollectionView<T, M extends IModel<T>>
    extends CollectionView<T> {

  private static final long serialVersionUID = 1L;

  public SpecificModelCollectionView(
      String id, IItemModelAwareCollectionModel<T, ?, ? extends M> collectionModel) {
