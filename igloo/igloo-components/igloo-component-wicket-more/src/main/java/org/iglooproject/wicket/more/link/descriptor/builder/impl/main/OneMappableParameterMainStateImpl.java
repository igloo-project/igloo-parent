...
final class OneMappableParameterMainStateImpl<
  ...
  @Override
  public <TParam2 extends Collection<TElement>, TElement>
      ITwoMappableParameterMainState<
              TParam1,
              TParam2,
              TLateTargetDefinitionPageLinkDescriptor,
  ...
  @Override
  public <TParam2 extends Collection<?>>
      ITwoMappableParameterMainState<
              TParam1,
              TParam2,
              TLateTargetDefinitionPageLinkDescriptor,
  ...
  private <TTarget, TLinkDescriptor>
      IOneParameterLinkDescriptorMapper<TLinkDescriptor, TParam1> createMapper(
  ...
  private class OneParameterChosenParameterStateImpl
    ...
    public IOneParameterLinkDescriptorMapper<TLateTargetDefinitionPageLinkDescriptor, TParam1> page(
        IDetachableFactory pageClassFactory) {
      return createMapper(
    ...
    @Override
    public IOneParameterLinkDescriptorMapper<
            TLateTargetDefinitionImageResourceLinkDescriptor, TParam1>
