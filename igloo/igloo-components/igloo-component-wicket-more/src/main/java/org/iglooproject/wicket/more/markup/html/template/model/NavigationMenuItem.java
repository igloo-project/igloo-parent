...
public class NavigationMenuItem implements IDetachable {
  ...
  public NavigationMenuItem subMenuItems(
      NavigationMenuItem firstSubMenuItem, NavigationMenuItem... otherSubMenuItems) {
  ...
  public void detach() {
    Detachables.detach(
        labelModel, cssClassesModel, iconClassesModel, pageLinkGenerator, subMenuForceOpenModel);
