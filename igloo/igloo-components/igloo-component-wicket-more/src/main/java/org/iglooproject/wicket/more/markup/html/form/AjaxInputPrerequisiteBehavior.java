...
/**
 * Makes sure that the attached component is disabled and that its model is null so long that a
 * given prerequisite component's input is null or invalid.<br>
...
public class AjaxInputPrerequisiteBehavior<T> extends AbstractAjaxInputPrerequisiteBehavior<T> {
  ...
  public AjaxInputPrerequisiteBehavior(
      FormComponent<T> prerequisiteField, ComponentBooleanProperty property) {
