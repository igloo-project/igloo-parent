...
public class GenericSelect2DropDownMultipleChoice<T> extends ListMultipleChoice<T> {
   ...
   * @param collectionSupplier A factory for new, empty collections to be put in <code>
  ...
  public GenericSelect2DropDownMultipleChoice<T> setSelectedObjectForcedInChoices(
