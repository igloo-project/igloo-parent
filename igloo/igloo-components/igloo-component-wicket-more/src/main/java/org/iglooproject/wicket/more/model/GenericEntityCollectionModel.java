...
public class GenericEntityCollectionModel<
  ...
  public static <K extends Serializable & Comparable<K>, E extends GenericEntity<K, ?>>
      GenericEntityCollectionModel<K, E> of(Class<E> clazz) {
    return new GenericEntityCollectionModel<>(clazz, Suppliers2.<E>arrayList());
  }

  public static <K extends Serializable & Comparable<K>, E extends GenericEntity<K, ?>>
      GenericEntityCollectionModel<K, E> of(
  ...
  protected GenericEntityCollectionModel(
      Class<E> clazz, SerializableSupplier2<? extends Collection<E>> collectionSupplier) {
