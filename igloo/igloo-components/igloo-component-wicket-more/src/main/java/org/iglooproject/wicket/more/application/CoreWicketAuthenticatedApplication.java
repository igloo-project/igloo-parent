...
public abstract class CoreWicketAuthenticatedApplication extends CoreWicketApplication
  ...
  public static CoreWicketAuthenticatedApplication get() {
    ...
    throw new WicketRuntimeException(
        "There is no CoreWicketAuthenticatedApplication attached to current thread "
  ...
  public Session newSession(Request request, Response response) {
    try {
      return webSessionClassRef
          .get()
          .getDeclaredConstructor(Request.class)
          .newInstance(request); // NOSONAR
  ...
  protected IUnauthorizedComponentInstantiationListener
      newUnauthorizedComponentInstantiationListener() {
  ...
  private static class CoreDefaultExceptionMapperProvider
      implements SerializableSupplier2<IExceptionMapper> {
