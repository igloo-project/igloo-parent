...
public class ChainedImageResourceLinkGeneratorImpl extends AbstractChainedLinkGenerator<IImageResourceLinkGenerator>
		implements IImageResourceLinkGenerator {

	private static final long serialVersionUID = -2475023459193693212L;

	public ChainedImageResourceLinkGeneratorImpl(Iterable<? extends IImageResourceLinkGenerator> chain) {
		super(chain);
	}
