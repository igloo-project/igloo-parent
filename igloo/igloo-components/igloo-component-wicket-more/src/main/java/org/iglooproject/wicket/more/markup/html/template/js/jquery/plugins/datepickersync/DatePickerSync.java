...
public class DatePickerSync implements ChainableStatement, IDetachable, Serializable {
  ...
  public DatePickerSync(
      Component precedent, Component suivant, DatePickerSyncActionOnUpdate actionOnUpdate) {
    if (precedent != null) {
  ...
  public CharSequence[] statementArgs() {
    ...
    if (!precedentsModelsDates.isEmpty()) {
      options.put(
          "precedentsModelsMaxDate",
          new DateOption(Ordering.<Date>natural().max(precedentsModelsDates)));
    }
    ...
    if (!suivantsModelsDates.isEmpty()) {
      options.put(
          "suivantsModelsMinDate",
          new DateOption(Ordering.<Date>natural().min(suivantsModelsDates)));
    }
  ...
  @SafeVarargs
  public final DatePickerSync addPrecedentsLocalDateModels(
      IModel<LocalDate> first, IModel<LocalDate>... rest) {
    for (IModel<LocalDate> precedent : Lists.asList(first, rest)) {
      if (precedent != null && precedent.getObject() != null) {
        addPrecedentsModels(
            () ->
                Date.from(precedent.getObject().atStartOfDay(ZoneId.systemDefault()).toInstant()));
      }
    }
    return this;
  }
  ...
  @SafeVarargs
  public final DatePickerSync addPrecedentsModels(
      IModel<? extends Date> first, IModel<? extends Date>... rest) {
  ...
  @SafeVarargs
  public final DatePickerSync addSuivantsLocalDateModels(
      IModel<LocalDate> first, IModel<LocalDate>... rest) {
    for (IModel<LocalDate> suivant : Lists.asList(first, rest)) {
      if (suivant != null && suivant.getObject() != null) {
        addSuivantsModels(
            () -> Date.from(suivant.getObject().atStartOfDay(ZoneId.systemDefault()).toInstant()));
      }
    }
    return this;
  }
  ...
  @SafeVarargs
  public final DatePickerSync addSuivantsModels(
      IModel<? extends Date> first, IModel<? extends Date>... rest) {
