...
public class FunctionOneParameterLinkDescriptorMapper<R, T>
    extends AbstractOneParameterLinkDescriptorMapper<ILinkGenerator, R> {
  ...
  public FunctionOneParameterLinkDescriptorMapper(
      SerializableFunction2<? super R, T> function,
