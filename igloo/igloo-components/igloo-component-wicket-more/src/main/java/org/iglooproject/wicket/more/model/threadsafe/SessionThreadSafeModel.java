...
/**
 * An alternative implementation of {@link Model} that is thread-safe, and may thus be used in
 ...
 *   <li>the model need not maintain a cache (on contrary to loadable/detachable models such as
 *       {@link SessionThreadSafeSimpleLoadableDetachableModel} or {@link
 *       SessionThreadSafeDerivedSerializableStateLoadableDetachableModel}).
 * </ul>
 *
 * <p><strong>WARNING:</strong> Access to members of the model object is obviously not secured by
 * this model in any way, so writing to the model object is <strong>NOT</strong> thread-safe, unless
 * the object implements thread safety.
 */
