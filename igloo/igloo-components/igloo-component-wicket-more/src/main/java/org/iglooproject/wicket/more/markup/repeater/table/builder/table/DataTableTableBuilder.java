...
public abstract class DataTableTableBuilder<T, S extends ISort<?>>
    implements IDataTableTableState<T, S> {
  ...
  @Override
  public IDataTableTableState<T, S> add(
      Behavior firstRowsBehavior, Behavior... otherRowsBehaviors) {
