...
public abstract class AbstractWicketRendererServiceImpl
    extends AbstractOfflinePanelRendererServiceImpl {

  @Autowired private IRunAsSystemService securityService;
  ...
  protected String renderComponent(
    ...
    return securityService.runAsSystem(
        () ->
            AbstractWicketRendererServiceImpl.super.renderComponent(
                offlineComponent, locale, variation));
  }
  ...
  protected String renderPage(
    ...
    return securityService.runAsSystem(
        () ->
            AbstractWicketRendererServiceImpl.super.renderPage(
                offlineComponent, locale, variation));
  }
}
