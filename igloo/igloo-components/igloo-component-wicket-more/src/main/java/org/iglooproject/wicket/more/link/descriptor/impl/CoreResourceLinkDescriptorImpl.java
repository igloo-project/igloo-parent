...
public class CoreResourceLinkDescriptorImpl
    extends AbstractCoreExplicitelyParameterizedLinkDescriptor implements IResourceLinkDescriptor {
  ...
  protected ResourceReference getValidResourceReference() throws LinkInvalidTargetRuntimeException {
    ...
    if (resourceReference == null) {
      throw new LinkInvalidTargetRuntimeException(
          "The target resourceReference of this ILinkDescriptor was null");
    }
