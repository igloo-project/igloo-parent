...
public abstract class AbstractNotificationContentDescriptorFactory
    extends AbstractWicketRendererServiceImpl {

  private static final Logger LOGGER =
      LoggerFactory.getLogger(AbstractNotificationContentDescriptorFactory.class);

  @Deprecated private static final String STYLE_ATTRIBUTE = "style";
  @Deprecated private static final String STYLE_ATTRIBUTE_SEPARATOR = "; ";
  ...
  @Autowired private IHtmlNotificationCssService cssService;

  @Autowired private IPropertyService propertyService;

  @Autowired private IJuiceInliner juiceInliner;

  protected AbstractNotificationContentDescriptorFactory(
      IWicketContextProvider wicketContextProvider) {
    super(wicketContextProvider);
  }

  protected abstract class AbstractWicketNotificationDescriptor
    ...
    private String renderBodyHtmlText(Locale locale) {
      return AbstractNotificationContentDescriptorFactory.this.renderPage(
          ...
          IOfflineComponentProvider.fromSupplier(
              () -> createPage(locale), (Class<Page>) (Object) getComponentClass()),
          locale);
    }
   ...
   */
  @Deprecated
  protected abstract class AbstractWicketNotificationPanelDescriptor
      implements INotificationContentDescriptor {
    ...
    private String renderBodyHtmlText(Locale locale) {
      return AbstractNotificationContentDescriptorFactory.this.renderComponent(
          // we can't ensure that component and class match with available generic information
          IOfflineComponentProvider.<Component>fromSupplier(
              () -> createComponent("htmlComponent"), (Class) (Object) getComponentClass()),
          locale);
    }
  ...
  protected abstract class AbstractSimpleWicketNotificationDescriptor
      extends AbstractWicketNotificationDescriptor {
    ...
    public final String renderSubject(Locale locale) {
      return AbstractNotificationContentDescriptorFactory.this
          .getRendererService()
          .localize(
   ...
   */
  @Deprecated
  protected abstract class AbstractSimpleWicketNotificationPanelDescriptor
      extends AbstractWicketNotificationPanelDescriptor {
  ...
  @Override
  protected String postProcessHtml(
      Component component, String htmlBody, Locale locale, String variation) {
    if (Objects.equals(
        propertyService.get(WicketMorePropertyIds.NOTIFICATION_INLINER_JUICE_ENABLED), true)) {
