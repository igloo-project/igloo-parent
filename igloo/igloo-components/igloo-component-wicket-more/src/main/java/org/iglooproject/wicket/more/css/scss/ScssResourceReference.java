...
public class ScssResourceReference extends ResourceReference {
	...
	public ScssResourceReference(Class<?> scope, String name, Locale locale, String style, String variation) {
