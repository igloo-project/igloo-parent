...
public abstract class AbstractThreeParameterLinkDescriptorMapper<L, T1, T2, T3>
  ...
  public abstract L map(
      Triplet<? extends IModel<T1>, ? extends IModel<T2>, ? extends IModel<T3>> param);
  ...
  private static final class DerivingModel<U1, U2, U> implements IModel<U> {
    ...
    public DerivingModel(
        Pair<? extends IModel<U1>, ? extends IModel<U2>> models,
        SerializableFunction2<Pair<U1, U2>, U> function) {
      super();
      this.models = models;
    ...
    public U getObject() {
      return function.apply(
          Pair.with(models.getValue0().getObject(), models.getValue1().getObject()));
    }
  }
  ...
  @Override
  public ITwoParameterLinkDescriptorMapper<L, T2, T3> setParameter1(
      final SerializableFunction2<Pair<T2, T3>, T1> function) {
    return new AbstractTwoParameterLinkDescriptorMapper<L, T2, T3>() {
      private static final long serialVersionUID = 1L;

      @Override
      public L map(Pair<? extends IModel<T2>, ? extends IModel<T3>> param) {
        return AbstractThreeParameterLinkDescriptorMapper.this.map(
            param.addAt0(new DerivingModel<>(param, function)));
      }
  ...
  public <U1 extends T1> IThreeParameterLinkDescriptorMapper<L, U1, T2, T3> castParameter1() {
    return new AbstractThreeParameterLinkDescriptorMapper<L, U1, T2, T3>() {
      ...
      @Override
      public L map(
          Triplet<? extends IModel<U1>, ? extends IModel<T2>, ? extends IModel<T3>> param) {
        return AbstractThreeParameterLinkDescriptorMapper.this.map(
            param.setAt0(ReadOnlyModel.<T1>of(param.getValue0())));
      }
  ...
  @Override
  public ITwoParameterLinkDescriptorMapper<L, T1, T3> setParameter2(
      final SerializableFunction2<Pair<T1, T3>, T2> function) {
    return new AbstractTwoParameterLinkDescriptorMapper<L, T1, T3>() {
      private static final long serialVersionUID = 1L;
      ...
      public L map(Pair<? extends IModel<T1>, ? extends IModel<T3>> param) {
        return AbstractThreeParameterLinkDescriptorMapper.this.map(
            param.addAt1(new DerivingModel<>(param, function)));
      }
  ...
  public <U2 extends T2> IThreeParameterLinkDescriptorMapper<L, T1, U2, T3> castParameter2() {
    return new AbstractThreeParameterLinkDescriptorMapper<L, T1, U2, T3>() {
      ...
      @Override
      public L map(
          Triplet<? extends IModel<T1>, ? extends IModel<U2>, ? extends IModel<T3>> param) {
        return AbstractThreeParameterLinkDescriptorMapper.this.map(
            param.setAt1(ReadOnlyModel.<T2>of(param.getValue1())));
      }
  ...
  @Override
  public ITwoParameterLinkDescriptorMapper<L, T1, T2> setParameter3(
      final SerializableFunction2<Pair<T1, T2>, T3> function) {
    return new AbstractTwoParameterLinkDescriptorMapper<L, T1, T2>() {
      private static final long serialVersionUID = 1L;
      ...
      public L map(Pair<? extends IModel<T1>, ? extends IModel<T2>> param) {
        return AbstractThreeParameterLinkDescriptorMapper.this.map(
            param.addAt2(new DerivingModel<>(param, function)));
      }
  ...
  public <U3 extends T3> IThreeParameterLinkDescriptorMapper<L, T1, T2, U3> castParameter3() {
    return new AbstractThreeParameterLinkDescriptorMapper<L, T1, T2, U3>() {
      ...
      @Override
      public L map(
          Triplet<? extends IModel<T1>, ? extends IModel<T2>, ? extends IModel<U3>> param) {
        return AbstractThreeParameterLinkDescriptorMapper.this.map(
            param.setAt2(ReadOnlyModel.<T3>of(param.getValue2())));
      }
