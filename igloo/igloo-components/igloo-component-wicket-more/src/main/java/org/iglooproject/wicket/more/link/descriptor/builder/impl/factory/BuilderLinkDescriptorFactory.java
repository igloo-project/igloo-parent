...
public abstract class BuilderLinkDescriptorFactory<TTarget, TLinkDescriptor>
  ...
  protected abstract TLinkDescriptor create(
      IModel<? extends TTarget> target,
  ...
  private static final BuilderLinkDescriptorFactory<Class<? extends Page>, IPageLinkDescriptor>
      PAGE =
          new BuilderLinkDescriptorFactory<Class<? extends Page>, IPageLinkDescriptor>() {
            ...
            @Override
            protected IPageLinkDescriptor create(
                IModel<? extends Class<? extends Page>> target,
                LinkParametersMapping parametersMapping,
                ILinkParameterValidator validator) {
  ...
  public static IBuilderLinkDescriptorFactory<ResourceReference, IResourceLinkDescriptor>
      resource() {
    return RESOURCE;
  }

  private static final BuilderLinkDescriptorFactory<ResourceReference, IResourceLinkDescriptor>
      RESOURCE =
          new BuilderLinkDescriptorFactory<ResourceReference, IResourceLinkDescriptor>() {
            ...
            @Override
            protected IResourceLinkDescriptor create(
                IModel<? extends ResourceReference> target,
                LinkParametersMapping parametersMapping,
                ILinkParameterValidator validator) {
  ...
  public static IBuilderLinkDescriptorFactory<ResourceReference, IImageResourceLinkDescriptor>
      imageResource() {
    return IMAGE_RESOURCE;
  }

  private static final BuilderLinkDescriptorFactory<ResourceReference, IImageResourceLinkDescriptor>
      IMAGE_RESOURCE =
          new BuilderLinkDescriptorFactory<ResourceReference, IImageResourceLinkDescriptor>() {
            ...
            @Override
            protected IImageResourceLinkDescriptor create(
                IModel<? extends ResourceReference> target,
                LinkParametersMapping parametersMapping,
                ILinkParameterValidator validator) {
