...
public class SequenceGridView<T> extends SequenceView<T> {
  ...
  public SequenceGridView(
      final String id,
      final List<? extends ICellPopulator<T>> populators,
  ...
  protected Item<ICellPopulator<T>> newCellItem(
      final String id, final int index, final IModel<ICellPopulator<T>> model) {
