...
/**
 * Container affichant une icône selon que le model soit true ou false. Par défaut un carré coché ou
 * non avec possibilité de personnaliser.
 */
public class BooleanIcon extends WebMarkupContainer {
  ...
  public BooleanIcon(
      ...
      IModel<String> trueIconClassModel,
      IModel<String> falseIconClassModel) {
        ...
        new ClassAttributeAppender(
            new LoadableDetachableModel<String>() {
              ...
              protected String load() {
                return Boolean.TRUE.equals(getBooleanModelObject())
                    ? getTrueIconClass()
                    : getFalseIconClass();
              }
            }));
