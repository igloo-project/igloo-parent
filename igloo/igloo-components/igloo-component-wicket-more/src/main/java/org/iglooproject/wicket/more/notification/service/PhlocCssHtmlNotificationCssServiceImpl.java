...
public class PhlocCssHtmlNotificationCssServiceImpl implements IHtmlNotificationCssService {
  ...
  private final Map<ICssResourceReference, Pair<IHtmlNotificationCssRegistry, Instant>>
  ...
  private synchronized IHtmlNotificationCssRegistry getRegistry(
    ...
    Pair<IHtmlNotificationCssRegistry, Instant> cacheEntry =
