...
public abstract class AbstractWebPageTemplate extends CoreWebPage {
  ...
  protected final IModel<List<BreadCrumbElement>> headPageTitlePrependedElementsModel =
      newBreadCrumbListModel();
  protected final IModel<List<BreadCrumbElement>> headPageTitleElementsModel =
      newBreadCrumbListModel();

  protected final IModel<Boolean> headPageTitleReversedModel = Model.of(false);
  protected final IModel<String> headPageTitleSeparatorModel =
      Model.of(DEFAULT_HEAD_PAGE_TITLE_SEPARATOR);
  protected final IModel<String> headPageTitleSeparatorReverseModel =
      Model.of(DEFAULT_HEAD_PAGE_TITLE_SEPARATOR_REVERSE);

  protected final IModel<List<BreadCrumbElement>> bodyBreadCrumbPrependedElementsModel =
      newBreadCrumbListModel();
  protected final IModel<List<BreadCrumbElement>> breadCrumbElementsModel =
      newBreadCrumbListModel();
  ...
  protected void addMenuElement(
      Class<? extends Page> selectedPageClass, String name, Class<? extends Page> pageClass) {
  ...
  protected void addMenuElement(
    ...
    BookmarkablePageLink<Void> link =
        new BookmarkablePageLink<>(name + "MenuLink", pageClass, parameters);
  ...
  /**
   * Add a breadcrumb element that will be shown in the page title. If none is added, the {@link
   * #breadCrumbElementsModel} will be used.
   */
  ...
  protected Component createHeadPageTitle(String wicketId) {
    return new HeadPageTitleBreadCrumbPanel(
        ...
        headPageTitleElementsModel,
        breadCrumbElementsModel,
  ...
  protected Component createBodyBreadCrumb(String wicketId) {
    return new BodyBreadCrumbPanel(
        wicketId, bodyBreadCrumbPrependedElementsModel, breadCrumbElementsModel);
  }
