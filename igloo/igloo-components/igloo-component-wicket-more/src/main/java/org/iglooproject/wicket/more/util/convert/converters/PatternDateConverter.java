...
public class PatternDateConverter extends AbstractConverter<Date> {
   ...
   *
   * <ul>
   *   <li>Model binding to a component
   *   <li>Model detaching
   * </ul>
   */
  ...
  /**
   * Back compatibility constructor. If pattern is taken from translations, then you should use a
   * ResourceModel with the IModel&lt;String> constructor
   */
