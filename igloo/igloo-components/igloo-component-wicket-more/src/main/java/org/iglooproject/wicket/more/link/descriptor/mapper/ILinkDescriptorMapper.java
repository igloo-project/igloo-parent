...
/**
 * An object that can create a {@link ILinkDescriptor} using a parameter, generally a single {@link IModel} or a
 * {@link Tuple} of {@link IModel}s.
 ...
 * {@link org.iglooproject.wicket.more.markup.repeater.table.builder.state.IAddedLabelColumnState#withLink(IOneParameterLinkDescriptorMapper)
...
public interface ILinkDescriptorMapper<L, P> extends IDetachable {
	 ...
	 * @param param The model(s) to be mapped in the resulting {@link ILinkDescriptor}. Depending on the sub-interface,
	 * this may be either directly a model (for {@link IOneParameterLinkDescriptorMapper}) or a tuple of models (for
	 * others, such as {@link ITwoParameterLinkDescriptorMapper} or {@link IThreeParameterLinkDescriptorMapper}).
