...
public class VisitFilters {
  ...
  private static final class PredicateVisitFilter implements IVisitFilter, Serializable {
    ...
    public PredicateVisitFilter(
        SerializablePredicate2<Object> objectVisitPredicate,
        SerializablePredicate2<Object> compositeVisitPredicate) {
      super();
  ...
  public static <T> IVisitFilter downToExcluding(
      Class<T> clazz, SerializablePredicate2<? super T> predicate) {
    SerializablePredicate2<Object> objectPredicate =
        Predicates2.not(new TypeSafePredicate<>(clazz, predicate));
    return new PredicateVisitFilter(objectPredicate, objectPredicate);
  }

  public static <T> IVisitFilter including(
      Class<T> clazz, SerializablePredicate2<? super T> predicate) {
  ...
  public static <T> IVisitFilter excluding(
      Class<T> clazz, SerializablePredicate2<? super T> predicate) {
    SerializablePredicate2<Object> objectPredicate =
        Predicates2.not(new TypeSafePredicate<>(clazz, predicate));
    return new PredicateVisitFilter(objectPredicate, Predicates2.alwaysTrue());
  ...
  public static <T> IVisitFilter downToIncluding(
      Class<T> clazz, SerializablePredicate2<? super T> predicate) {
    SerializablePredicate2<Object> objectPredicate =
        Predicates2.not(new TypeSafePredicate<>(clazz, predicate));
  ...
  private enum RenderedComponentsVisitFilter implements IVisitFilter {
    ...
    private boolean hasRenderedMarkup(Object object) {
      ...
      return component.isVisibleInHierarchy()
          || (parent == null || parent.isVisibleInHierarchy())
