...
public interface IActionColumnAddedAjaxActionState<T, I>
  ...
  @Override
  IActionColumnAddedAjaxActionState<T, I> withClass(
      Collection<
              ? extends
                  IDetachableFactory<
  ...
  @Override
  IActionColumnAddedAjaxActionState<T, I> when(
  ...
  @Override
  IActionColumnAddedAjaxActionState<T, I> whenPredicate(
  ...
  @Override
  IActionColumnAddedAjaxActionState<T, I> add(
