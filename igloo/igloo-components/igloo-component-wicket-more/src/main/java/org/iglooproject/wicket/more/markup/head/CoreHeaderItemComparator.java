...
public class CoreHeaderItemComparator extends PriorityFirstComparator {
	...
	private static final CoreHeaderItemComparator INSTANCE = new CoreHeaderItemComparator(CoreHeaderItemSpecificOrder.get(), true);

	private final IHeaderItemSpecificOrder headerItemSpecificOrder;

	public CoreHeaderItemComparator(IHeaderItemSpecificOrder headerItemSpecificOrder, boolean renderPageFirst) {
	...
	public int compare(RecordedHeaderItem o1, RecordedHeaderItem o2) {
		...
		order = Ordering.natural().nullsLast()
			.compare(
				headerItemSpecificOrder.order(o1),
				headerItemSpecificOrder.order(o2)
			);
