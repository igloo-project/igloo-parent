...
public final class WicketMorePropertyIds extends AbstractPropertyIds {
  ...
  public static final ImmutablePropertyId<Boolean> NOTIFICATION_INLINER_JUICE_ENABLED =
      immutable("notification.inliner.juice.enabled");
  public static final ImmutablePropertyId<URL> NOTIFICATION_INLINER_JUICE_URL =
      immutable("notification.inliner.juice.url");
  public static final ImmutablePropertyId<Integer> NOTIFICATION_INLINER_JUICE_RETRY_MAX_ATTEMPTS =
      immutable("notification.inliner.juice.retry.maxAttempts");
  public static final ImmutablePropertyId<Duration> NOTIFICATION_INLINER_JUICE_RETRY_WAIT_DURATION =
      immutable("notification.inliner.juice.retry.waitDuration");
  public static final ImmutablePropertyId<Duration>
      NOTIFICATION_INLINER_JUICE_RETRY_REQUEST_TIMEOUT =
          immutable("notification.inliner.juice.requestTimeout");
  public static final ImmutablePropertyId<String> NOTIFICATION_INLINER_JUICE_TOKEN =
      immutable("notification.inliner.juice.token");
