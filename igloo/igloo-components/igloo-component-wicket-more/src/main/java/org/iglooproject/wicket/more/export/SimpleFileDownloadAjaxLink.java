...
public abstract class SimpleFileDownloadAjaxLink extends AbstractFileDownloadAjaxLink {
  ...
  public SimpleFileDownloadAjaxLink(
      String id, WorkInProgressPopup loadingPopup, String fileNamePrefix, MediaType mediaType) {
  ...
  public SimpleFileDownloadAjaxLink(
      ...
      IModel<MediaType> mediaTypeModel) {
    this(
        id,
        loadingPopup,
  ...
  public SimpleFileDownloadAjaxLink(
      String id, WorkInProgressPopup loadingPopup, IModel<String> fileNameModel) {
