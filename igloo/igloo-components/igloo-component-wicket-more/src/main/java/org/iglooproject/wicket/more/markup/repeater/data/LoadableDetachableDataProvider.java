...
public abstract class LoadableDetachableDataProvider<T>
    implements IDataProvider<T>, IBindableDataProvider {
  ...
  public final Iterator<? extends T> iterator(long first, long count) {
    ...
    if (lastList != null
        && Long.valueOf(first).equals(lastFirst)
        && Long.valueOf(realCount).equals(lastCount)) {
