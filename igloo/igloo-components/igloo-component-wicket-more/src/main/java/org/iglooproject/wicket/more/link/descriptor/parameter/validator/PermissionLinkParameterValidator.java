...
/**
 * @deprecated Use {@link org.iglooproject.wicket.more.link.descriptor.builder.state.validator.IValidatorState#permission(IModel, String, String...)} <strong>once for each permission</strong> instead
 */
@Deprecated
