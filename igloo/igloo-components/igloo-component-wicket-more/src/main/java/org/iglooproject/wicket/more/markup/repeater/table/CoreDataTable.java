...
public class CoreDataTable<T, S extends ISort<?>> extends Panel implements IPageableItems {
  ...
  public CoreDataTable(
    ...
    this(
        id,
        columns,
        SequenceProviders.forDataProvider(dataProvider),
        rowsBehaviorFactories,
        tableBehaviors,
        rowsPerPage);
  }
  ...
  private void addToolbar(
      final AbstractCoreToolbar toolbar, final CoreToolbarsContainer container) {
  ...
  protected SequenceGridView<T> newGridView(
      String id, List<? extends IColumn<T, S>> columns, ISequenceProvider<T> sequenceProvider) {
  ...
  protected class DefaultGridView extends SequenceGridView<T> {
    ...
    public DefaultGridView(
        String id,
        List<? extends IColumn<T, S>> displayedColumns,
        ISequenceProvider<T> sequenceProvider) {
