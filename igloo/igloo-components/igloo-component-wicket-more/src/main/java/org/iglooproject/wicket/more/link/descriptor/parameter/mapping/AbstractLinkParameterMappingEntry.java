...
public abstract class AbstractLinkParameterMappingEntry implements ILinkParameterMappingEntry {
  ...
  protected <T> void inject(
      PageParameters targetParameters,
      ILinkParameterConversionService conversionService,
    ...
    if (mappedValue != null) {
      try {
        ...
        throw new LinkParameterInjectionException(
            "Error converting the value of parameter " + parameterName, e);
      }
  ...
  protected <T> T extract(
      PageParameters sourceParameters,
      ILinkParameterConversionService conversionService,
      String parameterName,
    ...
    if (parameterValue != null) {
      try {
        ...
        throw new LinkParameterExtractionException(
            "Error converting the value of parameter " + parameterName, e);
      }
    }
  ...
  protected Object extract(
      ...
      ILinkParameterConversionService conversionService,
      String parameterName,
      TypeDescriptor mappedTypeDescriptor)
      throws LinkParameterExtractionException {
    Args.notNull(sourceParameters, "sourceParameters");
    Args.notNull(conversionService, "conversionService");
      ...
      try {
        mappedValue =
            conversionService.convert(
                parameterValue, TypeDescriptor.valueOf(String.class), mappedTypeDescriptor);
      } catch (ConversionException e) {
        throw new LinkParameterExtractionException(
            "Error converting the value of parameter " + parameterName, e);
      }
