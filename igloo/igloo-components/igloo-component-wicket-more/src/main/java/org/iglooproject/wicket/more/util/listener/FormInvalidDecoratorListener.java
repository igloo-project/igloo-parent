...
public final class FormInvalidDecoratorListener {
  ...
  private static final Behavior IS_INVALID_BEHAVIOR =
      new ClassAttributeAppender(IS_INVALID_CSS_CLASS) {
  ...
  private static final Behavior PROPAGATE_IS_INVALID_BEHAVIOR =
      new Behavior() {
        private static final long serialVersionUID = 1L;
        ...
        public void renderHead(Component component, IHeaderResponse response) {
          ...
          sb.append(
                  new JsStatement()
                      .$(
                          component,
                          ".form-group, .form-floating, .form-decorator-invalid-group, .select2")
                      .removeClass(IS_INVALID_CSS_CLASS)
                      .render())
              .append(
                  new JsStatement()
                      .$(component, "." + IS_INVALID_CSS_CLASS)
                      .chain(
                          "parentsUntil",
                          JsUtils.quotes("#" + component.getMarkupId()),
                          JsUtils.quotes(
                              ".form-group, .form-floating, .form-decorator-invalid-group"))
              ...
              .append(
                  new JsStatement()
                      ...
                      .addClass(IS_INVALID_CSS_CLASS)
                      .render())
              // Les .form-decorator-invalid-reminder doivent prendre une apparence particulière en
              // cas d'erreur,
              // mais sans impacter l'apparence des sous-éléments comme le ferait un .is-invalid
              .append(
                  new JsStatement()
                      .$(component, ".form-decorator-invalid-reminder")
              ...
              .append(
                  new JsStatement()
                      ...
                      .chain(
                          "parentsUntil",
                          JsUtils.quotes("#" + component.getMarkupId()),
                          JsUtils.quotes(".form-decorator-invalid-reminder"))
  ...
  private static final MetaDataKey<Serializable> IS_INVALID =
      new MetaDataKey<Serializable>() {
        private static final long serialVersionUID = 1L;
  ...
  private static final MetaDataKey<Serializable> FORM_GROUP =
      new MetaDataKey<Serializable>() {
        private static final long serialVersionUID = 1L;
        ...
        public void onBeforeRespond(Map<String, Component> map, AjaxRequestTarget target) {
          target
              ...
              .visitChildren(
                  ...
                  (IVisitor<FormComponent<?>, Void>)
                      (formComponent, visit) -> {
                        // TODO RFO, voir si c'est la bonne méthode, est-ce qu'on fait un refresh
                        // ajax ? pas utile dans l'absolue
  ...
  private static List<? extends Component> getComponentsToDecorateWithCSS(
  ...
  private static <T extends Component> List<T> collect(
      FormComponent<?> formComponent, Class<T> clazz) {
    Builder<T> resultBuilder = ImmutableList.builder();
    formComponent.visitChildren(
        clazz, (IVisitor<T, Void>) (object, visit) -> resultBuilder.add(object));
