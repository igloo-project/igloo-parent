...
public interface IPageLinkGenerator extends ILinkGenerator, IDetachable {
   ...
   * descriptor, with the same parameters, using the given anchor.
   *
  ...
  /**
   * Sets the response page and parameters for the current {@link RequestCycle} to the value of this
   * link descriptor.
   *
   ...
   * @throws LinkParameterInjectionRuntimeException if an error occurred during parameters injection
   *     (most probably during the conversion)
  ...
  /**
   * Creates a {@link RestartResponseException} with the same page and parameters than this link
   * descriptor.
   *
   * @throws LinkInvalidTargetRuntimeException if the target page was invalid (null, for example)
   * @throws LinkParameterValidationRuntimeException if the parameters validation returned an error
  ...
  /**
   * Creates a {@link RestartResponseAtInterceptPageException} with the same page and parameters
  ...
  /**
   * Creates a {@link RedirectToUrlException} with the same page and parameters than this link
   * descriptor.
   *
   * @throws LinkInvalidTargetRuntimeException if the target page was invalid (null, for example)
   * @throws LinkParameterValidationRuntimeException if the parameters validation returned an error
   ...
   */
  RedirectToUrlException newRedirectToUrlException()
      throws LinkInvalidTargetRuntimeException,
          LinkParameterValidationRuntimeException,
          LinkParameterInjectionRuntimeException;
   ...
   * @see RedirectToUrlException
   */
  RedirectToUrlException newRedirectToUrlException(String anchor)
      throws LinkInvalidTargetRuntimeException,
          LinkParameterValidationRuntimeException,
          LinkParameterInjectionRuntimeException;
  ...
  /**
   * Returns true if the page pointed by the page link descriptor is equals to the one passed as
   * parameter.
   *
   * @return
   */
  ...
  /**
   * This method disables permission checking for this generator. Provides a workaround for full url
   * generation without being limited by permissions issues depending on the user logged in. May be
   * useful in mail notifications context for instance.
   *
   * <p>{@link IPageLinkGenerator#isAccessible()} keeps permission processing even if
   * bypassPermissions is called.
   *
