...
/**
 * This class exists mainly to avoid having to repeatedly write down TSelf in its expanded form (see
 * {@link OneMappableParameterMainStateImpl}), which would be really verbose.
 *
...
abstract class AbstractGenericOneMappableParameterMainStateImpl<
  ...
  public IAddedParameterMappingState<TSelf> map(
      ILinkParameterMappingEntryFactory<? super Unit<IModel<TParam1>>>
          parameterMappingEntryFactory) {
  ...
  @Override
  public IAddedParameterMappingState<TSelf> renderInUrl(
      String parameterName, BindingRoot<? super TParam1, ?> binding) {
  ...
  @Override
  public TSelf validator(
      IDetachableFactory<? super Unit<IModel<TParam1>>, ? extends Condition> conditionFactory) {
  ...
  public TLateTargetDefinitionPageResult page(
      IDetachableFactory<
              ? super Unit<IModel<TParam1>>, ? extends IModel<? extends Class<? extends Page>>>
          pageClassFactory) {
  ...
  public TLateTargetDefinitionResourceResult resource(
      IDetachableFactory<
              ? super Unit<IModel<TParam1>>, ? extends IModel<? extends ResourceReference>>
