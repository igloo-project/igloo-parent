...
public abstract class AbstractHistoryLog<
  ...
  public static final String ALL_OBJECTS_REFERENCE =
      ALL_OBJECTS_EMBEDDED + "." + HistoryValue.REFERENCE;
  public static final String MAIN_OBJECT = "mainObject";
  public static final String MAIN_OBJECT_EMBEDDED = MAIN_OBJECT + "Embedded";
  public static final String MAIN_OBJECT_REFERENCE =
      MAIN_OBJECT_EMBEDDED + "." + HistoryValue.REFERENCE;
