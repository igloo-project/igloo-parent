...
public final class CollectionDifferKeyStrategy<T, K>
    extends AbstractCollectionDifferStrategy<T, K> {
  ...
  public CollectionDifferKeyStrategy(
  ...
  protected Accessor createItemAccessor(K key) {
    return new CollectionItemByKeyAccessor<T, K>(
        key, keyFunction, keyEquivalence, toStringFunction.apply(key));
  }
