...
/**
 * A slightly modified version of {@link NodePathInclusionResolver} that does not assume that every
 * child node of an included node is also included.
 *
...
public class NonInheritingNodePathInclusionResolver implements InclusionResolver {
  ...
  public NonInheritingNodePathInclusionResolver setInclusion(
      final NodePath nodePath, final Inclusion inclusion) {
