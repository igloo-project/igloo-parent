...
public class CoreElasticSearchAnalyzersDefinitionProvider
  ...
  public void register(ElasticsearchAnalysisDefinitionRegistryBuilder builder) {
    ...
    builder
        .tokenFilter(WORDDELIMITERFILTER)
        .type("word_delimiter")
    ...
    builder
        .tokenFilter(PATTERNREPLACEFILTERPUNCTUATION)
        .type("pattern_replace")
        .param("pattern", "('-&\\.,\\(\\))")
        .param("replacement", " ")
        .param("replace", "all");
    builder
        .tokenFilter(PATTERNREPLACEFILTERNUMBER)
        .type("pattern_replace")
    ...
    builder
        .analyzer(HibernateSearchAnalyzer.KEYWORD_CLEAN)
        .withTokenizer(KEYWORDTOKENIZER)
    ...
    builder
        ...
        .withTokenizer(WHITESPACETOKENIZER)
        .withTokenFilters(
            ASCIIFOLDINGFILTER, WORDDELIMITERFILTER, LOWERCASEFILTER, ELASTICSEARCHTOKENFILTER);

    builder.normalizer(HibernateSearchNormalizer.KEYWORD);

    builder
        .normalizer(HibernateSearchNormalizer.KEYWORD_CLEAN)
        .withTokenFilters(ASCIIFOLDINGFILTER, LOWERCASEFILTER);
    ...
    builder
        ...
        .withTokenFilters(
            ASCIIFOLDINGFILTER,
            LOWERCASEFILTER,
            PATTERNREPLACEFILTERPUNCTUATION,
            PATTERNREPLACEFILTERNUMBER,
            TRIMFILTER);
  }
}
