...
/**
 * <p>{@link Configuration} class marker to trigger MANIFEST property loading.<p>
 * <p>All properties are prefixed by the provided prefix and can be targetted with placeholders: </p>
 * 
 * <pre>
 * version=${prefix.Implementation-Version}
 * </pre>
 * 
 * <p>To load MANIFEST info from an jar, provide an alternate class with clazz or className attribute.
 */
