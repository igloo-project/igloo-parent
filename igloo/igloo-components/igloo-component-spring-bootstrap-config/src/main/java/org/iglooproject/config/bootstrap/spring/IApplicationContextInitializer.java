...
public interface IApplicationContextInitializer {
  ...
  /**
   * Igloo application name; used to resolve some placeholders, especially in configuration
   * locations. This must be configured by an {@link ApplicationDescription} annotation.
   */
  ...
  /**
   * System property to set to true if you want that alternative bootstrap locations replace default
   * bootstrap locations. If not set, or false, alternative bootstrap locations are added to the
   * default ones.
   */
  public static final String BOOTSTRAP_OVERRIDE_DEFAULT_SYSTEM_PROPERTY =
      "igloo.bootstrapOverrideDefault";

  /**
   * Environment variable to set to true if you want that alternative bootstrap locations replace
   * default bootstrap locations. If not set, or false, alternative bootstrap locations are added to
   * the default ones.
   */
  public static final String BOOTSTRAP_OVERRIDE_DEFAULT_ENVIRONMENT =
      "IGLOO_BOOTSTRAP_OVERRIDE_DEFAULT";
}
