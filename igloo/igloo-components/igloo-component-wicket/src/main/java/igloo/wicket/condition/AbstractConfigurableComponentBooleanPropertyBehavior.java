...
public abstract class AbstractConfigurableComponentBooleanPropertyBehavior<
        T extends AbstractConfigurableComponentBooleanPropertyBehavior<T>>
    extends AbstractComponentBooleanPropertyBehavior implements IPlaceholderEnclosureBuilder<T> {
  ...
  protected AbstractConfigurableComponentBooleanPropertyBehavior(
      ComponentBooleanProperty property, Operator operator) {
    this(property, operator.getBooleanOperator());
  }

  private AbstractConfigurableComponentBooleanPropertyBehavior(
      ComponentBooleanProperty property, BooleanOperator operator) {
    super(property);
