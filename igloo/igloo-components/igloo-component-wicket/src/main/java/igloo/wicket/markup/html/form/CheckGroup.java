...
public class CheckGroup<T> extends org.apache.wicket.markup.html.form.CheckGroup<T> {
  ...
  /**
   * WARNING: using this constructor for anonymous classes (inline class declarations) will result
   * in compilation errors when using the official javac compilator. Only use this in named
   * subclasses or for direct, non-subclassing instantiation.
   *
   * @see InlineOverridableCheckGroup
   */
  public <C extends Collection<T>> CheckGroup(
