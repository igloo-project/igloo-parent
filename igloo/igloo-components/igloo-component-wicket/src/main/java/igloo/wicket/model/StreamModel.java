...
public abstract class StreamModel<T> implements IModel<Iterable<T>> {
  ...
  @SafeVarargs
  public final StreamModel<T> concat(
      IModel<? extends Iterable<? extends T>> firstModel,
  ...
  private class ConcatStreamModel extends StreamModel<T> {
    ...
    @SafeVarargs
    public ConcatStreamModel(
        IModel<? extends Iterable<? extends T>> firstModel,
        IModel<? extends Iterable<? extends T>>... otherModels) {
      super();
      this.models =
          ImmutableList.<IModel<? extends Iterable<? extends T>>>builder()
    ...
    public Iterable<T> getObject() {
      return Iterables.concat(
          Iterables.transform(models, Models.<Iterable<? extends T>>getObject()));
    }
