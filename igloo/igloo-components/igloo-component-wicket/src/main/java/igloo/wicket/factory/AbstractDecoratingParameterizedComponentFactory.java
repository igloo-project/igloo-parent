...
public abstract class AbstractDecoratingParameterizedComponentFactory<C extends Component, P>
    implements IOneParameterComponentFactory<C, P> {
  ...
  public AbstractDecoratingParameterizedComponentFactory(
      IOneParameterComponentFactory<? extends C, ? super P> delegate) {
    super();
