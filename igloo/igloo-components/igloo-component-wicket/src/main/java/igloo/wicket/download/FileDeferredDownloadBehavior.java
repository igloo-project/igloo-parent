...
public class FileDeferredDownloadBehavior extends AbstractDeferredDownloadBehavior {
  ...
  public FileDeferredDownloadBehavior(
      final IModel<File> fileModel, final IModel<String> fileNameModel, boolean addAntiCache) {
    this(
  ...
  public FileDeferredDownloadBehavior(
      IModel<LabelValue<String, File>> fileInformationModel, boolean addAntiCache) {
    super(
        ReadOnlyModel.<LabelValue<String, File>, File>of(
            fileInformationModel, input -> input != null ? input.getValue() : null),
        addAntiCache);
