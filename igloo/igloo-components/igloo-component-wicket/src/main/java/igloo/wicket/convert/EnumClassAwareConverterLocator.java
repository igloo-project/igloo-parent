 ...
 *
 * <p>(Example: <code>getClass()</code> returns <code>EnumType$1</code> if enum does have a class
 * body, but we want to perform convertor lookup based on <code>EnumType</code>).
 *
