package org.iglooproject.wicket.markup.html.model;
 ...
 */
public class ConcreteCollectionToCollectionWrapperModel<T, C extends Collection<T>> implements IModel<Collection<T>> {
	...
	public ConcreteCollectionToCollectionWrapperModel(IModel<C> concreteCollectionModel, SerializableSupplier<? extends C> concreteCollectionSupplier) {
