...
public class PercentageValidator extends RangeValidator<BigDecimal> {
	...
	private static final PercentageValidator DEFAULT_PERCENTAGE_AS_RATIO_VALIDATOR = new PercentageValidator(
			new BigDecimal("0"), new BigDecimal("1"), true);

	private static final PercentageValidator DEFAULT_PERCENTAGE_VALIDATOR = new PercentageValidator(
