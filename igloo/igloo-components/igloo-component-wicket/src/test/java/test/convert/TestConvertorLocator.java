...
class TestConvertorLocator {
	...
	void test_enumConvertorLocator_object() {
		...
		EnumClassAwareConverterLocator enumClassAwareConverterLocator = new EnumClassAwareConverterLocator(delegate);
	...
	void test_enumConvertorLocator_enumSimple() {
		IConverterLocator delegate = mock(IConverterLocator.class);
		EnumClassAwareConverterLocator enumClassAwareConverterLocator = new EnumClassAwareConverterLocator(delegate);
		Assertions.assertThat(ComplexEnum.SIMPLE.getClass().getName()).isEqualTo("test.convert.TestConvertorLocator$ComplexEnum");
	...
	void test_enumConvertorLocator_enumBody() {
		IConverterLocator delegate = mock(IConverterLocator.class);
		EnumClassAwareConverterLocator enumClassAwareConverterLocator = new EnumClassAwareConverterLocator(delegate);
		Assertions.assertThat(ComplexEnum.BODY.getClass().getName()).isEqualTo("test.convert.TestConvertorLocator$ComplexEnum$1");
