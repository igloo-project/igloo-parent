        ...
        () -> {
          ...
          settings.addAll(
              List.of(
                  ...
                  "component-path",
                  AvailableSettings.JAKARTA_HBM2DDL_CREATE_SOURCE,
                  "metadata-then-script",
                  AvailableSettings.JAKARTA_HBM2DDL_DROP_SOURCE,
                  "script-then-metadata",
                  AvailableSettings.JAKARTA_HBM2DDL_CREATE_SCRIPT_SOURCE,
                  new StringReader(
                      "create sequence fichier_id_seq; create sequence storageunit_id_seq;"),
                  AvailableSettings.JAKARTA_HBM2DDL_DROP_SCRIPT_SOURCE,
                  new StringReader(
