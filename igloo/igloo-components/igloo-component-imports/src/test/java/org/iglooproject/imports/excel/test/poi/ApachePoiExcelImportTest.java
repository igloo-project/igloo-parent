...
class ApachePoiExcelImportTest {
  ...
  void testSuccess() throws TableImportException {
    ...
    List<Quartet<Date, Boolean, String, Integer>> results =
    ...
    List<Quartet<Date, Boolean, String, Integer>> expectedResults =
        ImmutableList.of(
  ...
  private void assertValueEquals(
      ...
      int valueIndex,
      String valueName,
      Quartet<Date, Boolean, String, Integer> expectedResult,
      Quartet<Date, Boolean, String, Integer> actualResult) {
  ...
  private Quartet<Date, Boolean, String, Integer> newResult(
      Date date, Boolean bool, String string, Integer integer) {
