...
class ApachePoiExcelImportTest {
	...
	void testSuccess() throws TableImportException {
		...
		List<Quartet<LocalDate, Boolean, String, Integer>> results = importer.doImport(stream, "wellFormattedFile.xlsx");
		
		List<Quartet<LocalDate, Boolean, String, Integer>> expectedResults = ImmutableList.of(
	...
	private void assertValueEquals(int rowIndex, int valueIndex, String valueName,
			Quartet<LocalDate, Boolean, String, Integer> expectedResult, Quartet<LocalDate, Boolean, String, Integer> actualResult) {
	...
	private Quartet<LocalDate, Boolean, String, Integer> newResult(LocalDate date, Boolean bool, String string, Integer integer) {
