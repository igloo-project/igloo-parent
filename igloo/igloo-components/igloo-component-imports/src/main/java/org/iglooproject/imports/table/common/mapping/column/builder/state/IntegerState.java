...
public abstract class IntegerState<TTable, TRow, TCell, TCellReference>
    extends GenericIntegerFunctionBuildStateImpl<
  ...
  public <TValue> GenericState<TTable, TRow, TCell, TCellReference, TValue> transform(
      Function2<? super Integer, TValue> function) {
