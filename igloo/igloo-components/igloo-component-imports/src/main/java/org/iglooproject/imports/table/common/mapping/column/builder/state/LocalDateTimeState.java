...
public abstract class LocalDateTimeState<TTable, TRow, TCell, TCellReference>
    extends GenericLocalDateTimeBuildStateImpl<
  ...
  public <TValue> GenericState<TTable, TRow, TCell, TCellReference, TValue> transform(
      Function2<? super LocalDateTime, TValue> function) {
