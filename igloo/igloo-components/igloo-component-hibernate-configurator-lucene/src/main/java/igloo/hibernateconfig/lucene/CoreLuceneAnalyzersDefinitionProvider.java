...
public class CoreLuceneAnalyzersDefinitionProvider implements LuceneAnalysisDefinitionProvider {
  ...
  protected void registerWithPrefix(
      String prefix, LuceneAnalysisDefinitionRegistryBuilder builder) {
    builder
        .analyzer(prefix + HibernateSearchAnalyzer.KEYWORD)
        .tokenizer(KeywordTokenizerFactory.class);

    builder
        .analyzer(prefix + HibernateSearchAnalyzer.KEYWORD_CLEAN)
        .tokenizer(KeywordTokenizerFactory.class)
        .tokenFilter(ASCIIFoldingFilterFactory.class)
        .tokenFilter(LowerCaseFilterFactory.class);

    builder
        .analyzer(prefix + HibernateSearchAnalyzer.TEXT)
    ...
    builder
        .analyzer(prefix + HibernateSearchAnalyzer.TEXT_STEMMING)
        .tokenizer(WhitespaceTokenizerFactory.class)
        .tokenFilter(ASCIIFoldingFilterFactory.class)
        .tokenFilter(WordDelimiterFilterFactory.class)
        .param("generateWordParts", "1")
    ...
    builder
        .normalizer(prefix + HibernateSearchNormalizer.KEYWORD_CLEAN)
        .tokenFilter(ASCIIFoldingFilterFactory.class)
        .tokenFilter(LowerCaseFilterFactory.class);
