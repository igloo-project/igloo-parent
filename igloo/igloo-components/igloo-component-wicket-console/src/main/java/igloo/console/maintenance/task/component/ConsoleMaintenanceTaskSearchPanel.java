...
public class ConsoleMaintenanceTaskSearchPanel extends Panel {
  ...
  public ConsoleMaintenanceTaskSearchPanel(
      String id, IPageable pageable, QueuedTaskHolderDataProvider dataProvider) {
    super(id);
