...
public final class ConsoleConfiguration {
  ...
  private IComponentFactory<Component> consoleAccessHeaderAdditionalContentComponentFactory =
      InvisiblePanel::new;

  private IComponentFactory<Component> consoleHeaderEnvironmentComponentFactory =
      InvisiblePanel::new;

  private IComponentFactory<Component> consoleHeaderAdditionalContentComponentFactory =
      InvisiblePanel::new;

  public static ConsoleConfiguration get() {
    if (!StringUtils.hasText(INSTANCE.baseUrl)) {
      throw new IllegalStateException(
          "La console doit être initialisée par l'application avec une url de base.");
    }
    return INSTANCE;
  }
  ...
  /**
   * Initiate a ConsoleConfiguration object with default pages and external contributions (see
   * {@link IConsolePageProvider}). If you provide a not-null <code>customConfiguration</code>,
   * default pages are not added by this method. If appropriate, you may call <code>
   * this.buildDefault()</code> in your <code>customConfiguration</code>.
   */
  public static ConsoleConfiguration build(
      String baseUrl,
  ...
  public void buildDefault() {
    ...
    ConsoleMenuItemRelatedPage maintenanceTaskDetailPage =
        new ConsoleMenuItemRelatedPage(
   ...
   * @param menuPredicate predicate to select menu for insertion (before or after item, see next
   *     argument)
   * @param beforeMenuItem if true, <code>newMenuItem</code> is added before selected menu item;
   *     else after
   * @param firstIfNotFound if true, and <code>menuPredicate</code> fails to find an entry, <code>
   *     newMenuItem</code> is added first in its section; else last
   */
  public void insertMenu(
      ConsoleMenuItem newMenuItem,
  ...
  private void mountMenuSection(ConsoleMenuSection menuSection, WebApplication webApplication) {
    ...
    for (ConsoleMenuItem menuItem : menuSection.getMenuItems()) {
      webApplication.mountPage(
          menuSectionBaseUrl + menuItem.getUrlFragment() + "/", menuItem.getPageClass());

      for (ConsoleMenuItemRelatedPage relatedPage : menuItem.getRelatedPages()) {
        webApplication.mountPage(
            menuSectionBaseUrl + menuItem.getUrlFragment() + relatedPage.getUrlFragment() + "/",
  ...
  public boolean addConsoleAccessCssResourceReference(
      ResourceReference consoleAccessCssResourceReference) {
  ...
  public void setConsoleAccessHeaderAdditionalContentComponentFactory(
      IComponentFactory<Component> consoleAccessHeaderAdditionalContentComponentFactory) {
    this.consoleAccessHeaderAdditionalContentComponentFactory =
        consoleAccessHeaderAdditionalContentComponentFactory;
  }
  ...
  public void setConsoleHeaderEnvironmentComponentFactory(
      IComponentFactory<Component> consoleHeaderEnvironmentComponentFactory) {
  ...
  public void setConsoleHeaderAdditionalContentComponentFactory(
      IComponentFactory<Component> consoleHeaderAdditionalContentComponentFactory) {
    this.consoleHeaderAdditionalContentComponentFactory =
        consoleHeaderAdditionalContentComponentFactory;
  }
