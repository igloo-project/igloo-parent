package igloo.console.maintenance.file.page;
...
public class ConsoleMaintenanceFilePage extends ConsoleMaintenanceTemplate {
    ...
    add(
        new Form<Void>("form") {
          ...
          protected void onSubmit() {
            try {
              HashTableFileStorePathGeneratorImpl pathGenerator =
                  new HashTableFileStorePathGeneratorImpl(hashTableByteSizeModel.getObject());
              pathModel.setObject(
                  pathGenerator.getFilePath(fileKeyModel.getObject(), extensionModel.getObject()));
              pathModel.detach();
            } catch (Exception e) {
  ...
  protected void onDetach() {
    super.onDetach();
    Detachables.detach(hashTableByteSizeModel, fileKeyModel, extensionModel, pathModel);
  }
