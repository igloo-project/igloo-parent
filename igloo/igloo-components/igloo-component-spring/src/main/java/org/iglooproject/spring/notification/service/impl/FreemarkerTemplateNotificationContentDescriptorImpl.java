...
public class FreemarkerTemplateNotificationContentDescriptorImpl implements INotificationContentDescriptor {
	...
	public FreemarkerTemplateNotificationContentDescriptorImpl(
			Configuration templateConfiguration, String templateKey,
	...
	private String renderSubject(Locale locale) throws NotificationContentRenderingException {
		try {
			...
			throw new NotificationContentRenderingException("Exception while rendering notification subject from freemarker template", e);
		}
	}
	...
	private String renderBodyPlainText(Locale locale) throws NotificationContentRenderingException {
		try {
			...
			throw new NotificationContentRenderingException("Exception while rendering notification body from freemarker template", e);
		}
	}
	...
	/**
	 * If locale == null, the variables will be considered as not locale-sensitive and will be available for all locales.
	 */
	...
	private String getMailElement(MailElement element, Locale locale)
		...
		if (freemarkerModelMap.containsKey(element.toString())) {
			throw new IllegalStateException(String.format("Variable name '%1$s' is reserved to implementation purposes. Users cannot use it.", element));
		}
