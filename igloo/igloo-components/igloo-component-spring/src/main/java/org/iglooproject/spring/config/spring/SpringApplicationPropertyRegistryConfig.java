...
@Configuration
public class SpringApplicationPropertyRegistryConfig
    extends AbstractApplicationPropertyRegistryConfig {

  private static final Logger LOGGER =
      LoggerFactory.getLogger(SpringApplicationPropertyRegistryConfig.class);
  ...
  public void register(IPropertyRegistry registry) {
    ...
    registry.register(
        CONFIGURATION_TYPE,
        input -> {
          if (SpringPropertyIds.CONFIGURATION_TYPE_DEVELOPMENT.equals(input)
              || SpringPropertyIds.CONFIGURATION_TYPE_DEPLOYMENT.equals(input)) {
            return input;
          } else {
            throw new IllegalStateException(
                "Configuration type should be either development or deployment");
          }
        });
    ...
    registry.registerEnum(
        NOTIFICATION_MAIL_SENDER_BEHAVIOR, MailSenderBehavior.class, MailSenderBehavior.EXPLICIT);
    registry.registerEnum(
        NOTIFICATION_MAIL_SEND_MODE, NotificationSendMode.class, NotificationSendMode.SEND);
    registry.register(
        NOTIFICATION_MAIL_FILTER_EMAILS,
