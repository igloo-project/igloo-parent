...
/**
 * <code>@ConditionalOnBean + @ComponentScan</code> is broken. see
 * https://github.com/spring-projects/spring-boot/issues/1625.
 *
 * <p>This class provides a workaround. Implement {@link #getComponentScanPackages()} in your own
 * <code>@Configuration</code> class and <code>@Import</code> it on your AutoConfiguration.
 */
public abstract class AbstractComponentScanConfigurationWorkaround
  ...
  public void registerBeanDefinitions(
    ...
    for (Class<?> basePackageClass : getComponentScanPackages()) {
      ...
      Set<BeanDefinition> definitions =
          scanner.findCandidateComponents(basePackageClass.getPackage().getName());
      // usage of ClassPathScanningCandidateComponentProvider extracted from
      // ClassPathBeanDefinitionParser#doScan
  ...
  protected abstract Class<?>[] getComponentScanPackages();
