...
public class ExplicitelyDefinedNotificationContentDescriptorImpl implements INotificationContentDescriptor {
	...
	/**
	 * If locale == null, the given subject will be used for any unreferenced
	 * locale
	 */
	...
	public INotificationContentBody renderBody(Locale locale) {
		return NotificationContentBody.start().with(Failable.asConsumer(o -> {
	...
	/**
	 * If locale == null, the given body will be used for any unreferenced
	 * locale
	 */
	...
	private static class Wrapper implements INotificationContentDescriptor {
		...
		public boolean equals(Object obj) {
			if (obj instanceof Wrapper) {
				...
				return new EqualsBuilder().append(wrapped, other.wrapped).append(locale, other.locale).build();
			}
			return false;
		}
