...
/**
 * Classe à implémenter avec une méthode statique fournissant un {@link
 * PropertySourcesPlaceholderConfigurer} vide. L'annotation {@link ApplicationDescription} permet de
 * configurer le nom de l'application.
 *
 * <p>L'annotation {@link ConfigurationLocations} est dépréciée en faveur de l'annotation standard
 * {@link PropertySource}
 *
