...
public final class MutablePropertyIdTemplate<T> extends PropertyIdTemplate<T, MutablePropertyId<T>>
  ...
  /**
   * This constructor is package-protected. Use {@link AbstractPropertyIds#mutableTemplate(String)}
   * for building this type of property ID template.
   */
  /*package*/ MutablePropertyIdTemplate(
