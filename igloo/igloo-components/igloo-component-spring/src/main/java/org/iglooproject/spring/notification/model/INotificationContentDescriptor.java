...
public interface INotificationContentDescriptor {
   ...
   * @return A notification content descriptor that does the same as <code>this</code> but takes
   *     into account some context relative to the recipient (such as its locale, for instance).
   *     This content descriptor implements {@link #equals(Object)} and {@link #hashCode()} so that
   *     the rendering of single notification for multiple recipients whose context is the same may
