...
/**
 * Utilitaire permettant de manipuler les chaînes de caractères.
 *
 * <p>Il permet de wrapper des méthodes des StringUtils de Spring et des StringUtils de commons-lang
 * et ajoute par ailleurs quelques méthodes complémentaires dont le removeAccents qui provient de
 * Lucene.
 *
 * @author Open Wide
 */
public final class StringUtils extends org.springframework.util.StringUtils {
  ...
  public static final Pattern CLEAN_SPECIAL_CHARS_QUERY_REGEXP_PATTERN =
  ...
  public static final String NEW_LINE_ANTISLASH_R_ANTISLASH_N =
      NEW_LINE_ANTISLASH_R + NEW_LINE_ANTISLASH_N;
  ...
  /**
   * Supprime les caractères spéciaux d'une chaîne de caractères et retourne une chaîne utilisable
   * dans une URL.
   *
   ...
   * pour un tag.
   *
   * <p>La grande différence par rapport à une URL est qu'on autorise les ".", notamment pour
   * pouvoir définir des numéros de version.
   *
   * @param strToClean chaîne à nettoyer
   * @return chaîne nettoyée
   */
  ...
  /**
   * Nettoie une chaîne de caractères qui part à destination d'une recherche Lucene. On souhaite
   * autoriser le fait qu'il puisse y avoir un wildcard.
   */
