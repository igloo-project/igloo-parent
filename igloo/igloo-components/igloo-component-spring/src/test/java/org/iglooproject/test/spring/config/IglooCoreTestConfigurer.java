package org.iglooproject.test.spring.config;

import org.iglooproject.spring.config.AbstractConfigurer;

@SuppressWarnings("deprecation")
public class IglooCoreTestConfigurer extends AbstractConfigurer {
	...
	public IglooCoreTestConfigurer() {
	}
