...
class TestPropertyService {
  ...
  @Mock private IImmutablePropertyDao immutablePropertyDao;

  @Mock private IMutablePropertyDao mutablePropertyDao;
  ...
  private static class PropertyIds extends AbstractPropertyIds {
    ...
    static final MutablePropertyId<String> MUTABLE_STRING_WITH_DEFAULT =
        mutable("mutable.property.string.default");
  }

  private static class ImmutablePropertyIds extends AbstractPropertyIds {
    static final ImmutablePropertyId<String> IMMUTABLE_STRING =
        immutable("immutable.property.string");
  ...
  void mutablePropertyGet() throws ServiceException, SecurityServiceException {
    initPropertyService(
        new IPropertyRegistryConfig() {
          ...
          public void register(IPropertyRegistry propertyService) {
            ...
            propertyService.registerString(
                PropertyIds.MUTABLE_STRING_WITH_DEFAULT, "MyDefaultValue");
          }
        });
    ...
    when(mutablePropertyDao.getInTransaction("mutable.property.string.default"))
        .thenReturn("MyDefaultValue");
  ...
  private static class DuplicatePropertyIds extends AbstractPropertyIds {
    static final MutablePropertyId<String> MUTABLE_STRING =
        mutable(ImmutablePropertyIds.IMMUTABLE_STRING.getKey());
    static final ImmutablePropertyId<String> IMMUTABLE_STRING =
        immutable(ImmutablePropertyIds.IMMUTABLE_STRING.getKey());
  }
