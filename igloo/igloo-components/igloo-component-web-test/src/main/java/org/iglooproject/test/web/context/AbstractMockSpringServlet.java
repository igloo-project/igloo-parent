...
public abstract class AbstractMockSpringServlet extends AbstractMockServlet {
  ...
  public AbstractMockSpringServlet(
  ...
  protected void configureContext(WebappContext context) {
    ...
    context.setInitParameter(
        ContextLoader.CONTEXT_CLASS_PARAM, AnnotationConfigWebApplicationContext.class.getName());
    ...
    context.setInitParameter(
        ...
        Joiner.on(",")
            .join(initializers.stream().map(Class::getName).collect(Collectors.toList())));
