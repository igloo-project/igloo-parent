...
public class JQPlotLinesPanel<S, K, V extends Number & Comparable<V>, TK> extends JQPlotPanel<S, K, V, TK> {

	private static final long serialVersionUID = -5575918534912813908L;

	public JQPlotLinesPanel(String id, IJQPlotDataAdapter<S, K, V, TK> dataAdapter) {
