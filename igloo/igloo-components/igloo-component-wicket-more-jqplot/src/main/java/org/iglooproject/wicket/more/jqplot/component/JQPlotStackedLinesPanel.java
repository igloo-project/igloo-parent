...
public class JQPlotStackedLinesPanel<S, K, V extends Number & Comparable<V>, TK>
    extends JQPlotPanel<S, K, V, TK> {

  private static final long serialVersionUID = -5575918534912813908L;

  public JQPlotStackedLinesPanel(String id, IJQPlotDataAdapter<S, K, V, TK> dataAdapter) {
    ...
    add(
        new AbstractJQPlotConfigurer<S, K>() {
          ...
          public void configure(
            ...
            options.getSeriesDefaults().setFillToZero(true).setFill(true).setFillAndStroke(true);
          }
        });
  }
}
