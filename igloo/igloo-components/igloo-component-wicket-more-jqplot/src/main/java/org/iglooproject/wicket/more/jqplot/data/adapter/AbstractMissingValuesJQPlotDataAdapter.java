...
public abstract class AbstractMissingValuesJQPlotDataAdapter<S, K, V, TK>
    extends AbstractJQPlotDataAdapter<S, K, V, TK> {
  ...
  public AbstractMissingValuesJQPlotDataAdapter(
    ...
    this.seriesModel =
        seriesModel != null
            ? seriesModel
            : new IModel<Collection<? extends S>>() {
    ...
    this.keysModel =
        keysModel != null
            ? keysModel
            : new IModel<Collection<? extends K>>() {
              private static final long serialVersionUID = 1L;
    ...
    this.missingValueReplacementModel =
        missingValueReplacementModel == null
            ? Models.<V>placeholder()
