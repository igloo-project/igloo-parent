...
public final class JQPlotConfigurers {
  ...
  private static class TitleJQPlotConfigurer extends AbstractJQPlotConfigurer<Object, Object> {
    ...
    public void configure(
        PlotOptions options,
        Map<?, PlotSeries> seriesMap,
        Map<?, PlotTick> keysMap,
        Locale locale) {
      options.setTitle(
          Localizer.get().getString(titleKey, null, null, locale, null, (String) null));
    }
  }

  public static <K> IJQPlotConfigurer<Object, K> keysColors(
      SerializableFunction2<? super K, ? extends Color> seriesColorFunction) {
  ...
  public static <K> IJQPlotConfigurer<Object, K> keysColors(
    ...
    return new KeysColorsFunctionJQPlotConfigurer<>(
        seriesColorFunction, negativeSeriesColorFunction);
  }

  private static class KeysColorsFunctionJQPlotConfigurer<K>
      extends AbstractJQPlotConfigurer<Object, K> {
    ...
    public KeysColorsFunctionJQPlotConfigurer(
        SerializableFunction2<? super K, ? extends Color> keysColorFunction,
        SerializableFunction2<? super K, ? extends Color> negativeSeriesColorFunction) {
      super();
  ...
  public static <S> IJQPlotConfigurer<S, Object> seriesColors(
      SerializableFunction2<? super S, ? extends Color> seriesColorFunction) {
  ...
  public static <S> IJQPlotConfigurer<S, Object> seriesColors(
    ...
    return new SeriesColorsFunctionJQPlotConfigurer<>(
        seriesColorFunction, negativeSeriesColorFunction);
  }

  private static class SeriesColorsFunctionJQPlotConfigurer<S>
      extends AbstractJQPlotConfigurer<S, Object> {
    private static final long serialVersionUID = -7455227724829756556L;
    ...
    public SeriesColorsFunctionJQPlotConfigurer(
        SerializableFunction2<? super S, ? extends Color> seriesColorFunction,
        SerializableFunction2<? super S, ? extends Color> negativeSeriesColorFunction) {
      super();
  ...
  public static IJQPlotConfigurer<Object, Object> seriesColors(
      Iterable<? extends Color> colors, Iterable<? extends Color> negativeColors) {
    return new SeriesColorsListJQPlotConfigurer(colors, negativeColors);
  }

  private static class SeriesColorsListJQPlotConfigurer
      extends AbstractJQPlotConfigurer<Object, Object> {
    private static final long serialVersionUID = -7455227724829756556L;
    ...
    public SeriesColorsListJQPlotConfigurer(
        Iterable<? extends Color> colors, Iterable<? extends Color> negativeColors) {
      super();
  ...
  private static final IJQPlotConfigurer<Object, Object> SERIES_LABELS_DISABLED =
      new AbstractJQPlotConfigurer<Object, Object>() {
        private static final long serialVersionUID = 1L;
  ...
  public static <S> IJQPlotConfigurer<S, Object> seriesLabels(
      IConverter<? super S> serieLabelConverter) {
  ...
  private static class SeriesLabelsJQPlotConfigurer<S> extends AbstractJQPlotConfigurer<S, Object> {
    ...
    public void configure(
      ...
      for (Map.Entry<? extends S, PlotSeries> seriesEntry : seriesMap.entrySet()) {
        seriesEntry
            .getValue()
            .setLabel(serieLabelConverter.convertToString(seriesEntry.getKey(), locale));
      }
    }
  }
  ...
  private static final IJQPlotConfigurer<Object, Object> Y_AXIS_FLOAT_FORMAT =
      new AbstractJQPlotConfigurer<Object, Object>() {
        private static final long serialVersionUID = 1L;
        ...
        public void configure(
            ...
            Map<?, PlotTick> keysMap,
            Locale locale) {
          options.getAxes().getYaxis().getTickOptions().setFormatString("%.1f");
          options.getAxes().getYaxis().setMax(null).setTickInterval(null);
        }
      };
  ...
  private static class YAxisWindowJQPlotConfigurer<V extends Number>
      extends AbstractJQPlotConfigurer<Object, Object> {
    private static final long serialVersionUID = 1L;
    ...
    public void configure(
        ...
        Map<?, PlotTick> keysMap,
        Locale locale) {
      options.getAxes().getYaxis().setMin(min).setMax(max);
    }
  }
  ;
  ...
  private static final IJQPlotConfigurer<Object, Object> Y_AXIS_DISABLED =
      new AbstractJQPlotConfigurer<Object, Object>() {
        private static final long serialVersionUID = 1L;
  ...
  private static final IJQPlotConfigurer<Object, Object> Y_AXIS_GRIDLINES_ONLY =
      new AbstractJQPlotConfigurer<Object, Object>() {
        private static final long serialVersionUID = 1L;
  ...
  private static final IJQPlotConfigurer<Object, Object> X_AXIS_DISABLED =
      new AbstractJQPlotConfigurer<Object, Object>() {
        private static final long serialVersionUID = 1L;
