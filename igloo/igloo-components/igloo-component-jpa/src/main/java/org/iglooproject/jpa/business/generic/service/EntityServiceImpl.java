...
public class EntityServiceImpl implements IEntityService {
  ...
  @Autowired private IEntityDao entityDao;
  ...
  @Override
  public <E extends GenericEntity<?, ?>> List<E> listEntity(
      GenericEntityCollectionReference<?, E> reference) {
    return entityDao.listEntity(reference);
  }

  @Override
  public <E extends GenericEntity<?, ?>> IQuery<E> getQuery(
      final GenericEntityCollectionReference<?, E> reference) {
    // The query must be defined as an (external) bean so that the version of entityService it uses
    // has been proxified
  ...
  @Override
  public <E extends GenericEntity<?, ?>> List<Class<? extends E>> listAssignableEntityTypes(
      Class<E> superclass) {
