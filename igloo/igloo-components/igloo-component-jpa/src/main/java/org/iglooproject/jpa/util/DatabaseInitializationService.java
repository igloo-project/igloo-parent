...
public class DatabaseInitializationService {
  ...
  /** Méthode utilisée par l'initialisation spring pour la mise en place du {@link DataSource} */
  ...
  /**
   * Exécute les requêtes SQL d'un fichier. Une erreur sur une requête n'interrompt pas le
   * processing mais affiche un message d'erreur.
   *
