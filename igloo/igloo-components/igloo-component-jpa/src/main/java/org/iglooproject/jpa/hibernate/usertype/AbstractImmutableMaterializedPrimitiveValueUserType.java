 ...
 */
public abstract class AbstractImmutableMaterializedPrimitiveValueUserType<
  ...
  public void nullSafeSet(
    ...
    if (value == null) {
      ...
      delegateType.nullSafeSet(
          st, ((AbstractMaterializedPrimitiveValue<?, ?>) value).getValue(), index, session);
    }
  }
