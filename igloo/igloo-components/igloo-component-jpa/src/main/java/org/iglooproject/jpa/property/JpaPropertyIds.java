...
public final class JpaPropertyIds extends AbstractPropertyIds {
   ...
   */
  public static final ImmutablePropertyId<DatasourceProvider> DB_DATASOURCE_PROVIDER =
      immutable("db.datasourceProvider");
  ...
  public static final ImmutablePropertyId<Boolean> HIBERNATE_SEARCH_ELASTICSEARCH_ENABLED =
      immutable("hibernate.search.elasticsearch.enabled");
  public static final ImmutablePropertyId<String> HIBERNATE_SEARCH_ELASTICSEARCH_HOST =
      immutable("hibernate.search.default.elasticsearch.host");
}
