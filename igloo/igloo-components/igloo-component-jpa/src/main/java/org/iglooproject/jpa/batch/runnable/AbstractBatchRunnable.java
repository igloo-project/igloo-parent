 ...
 *
 * <p>This class is package-protected: use either {@link ReadOnlyBatchRunnable} or {@link
 * ReadWriteBatchRunnable} as as superclass for your implementation. Or, alternatively, implement
 * {@link IBatchRunnable} directly.
 */
/*package-protected*/ abstract class AbstractBatchRunnable<E> implements IBatchRunnable<E> {
  ...
  public void onError(ExecutionException exception) {
    throw new IllegalStateException(
        String.format("Unhandled exception when running %s", this), exception);
  }
}
