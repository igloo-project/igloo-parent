 ...
 * 
 * QueryDSL defines a lot of operators which are not mapped in HQL as they are not supported.
 * We can define these specific functions/operators here and use this template when creating the JPAQuery.
 */
