...
public final class GroupBy2 {
   ...
   */
  public static <R, C, V, R2, C2, V2>
      AbstractGroupExpression<Triplet<R, C, V>, Table<R2, C2, V2>> table(
          GroupExpression<R, R2> row, GroupExpression<C, C2> column, GroupExpression<V, V2> value) {
    return new GTable.Mixin<>(
        row, column, value, GTable.createLinked(QTriplet.create(row, column, value)));
  }
   ...
   *
   * @param row row for the sortedTable entries
   * @param column column for the sortedTable entries
   * @param value value for the sortedTable entries
   * @return wrapper expression
   */
  public static <R, C, V, R2 extends Comparable<? super R2>, C2 extends Comparable<? super C2>, V2>
      AbstractGroupExpression<Triplet<R, C, V>, RowSortedTable<R2, C2, V2>> sortedTable(
          GroupExpression<R, R2> row, GroupExpression<C, C2> column, GroupExpression<V, V2> value) {
    return new GTable.Mixin<>(
        row, column, value, GTable.createSorted(QTriplet.create(row, column, value)));
  }
  ...
  public static <R, C, V>
    ...
    return GTable.createSorted(
        QTriplet.create(row, column, value), rowComparator, columnComparator);
  }

  /**
   * @see #sortedTable(GroupExpression, GroupExpression, GroupExpression, Comparator, Comparator)
   */
  public static <R, C, V, R2>
      AbstractGroupExpression<Triplet<R, C, V>, RowSortedTable<R2, C, V>> sortedTable(
          GroupExpression<R, R2> row,
          Expression<C> column,
          Expression<V> value,
          Comparator<? super R2> rowComparator,
          Comparator<? super C> columnComparator) {
    return sortedTable(
   ...
   * @see #sortedTable(GroupExpression, GroupExpression, GroupExpression, Comparator, Comparator)
   */
  public static <R, C, V, C2>
      AbstractGroupExpression<Triplet<R, C, V>, RowSortedTable<R, C2, V>> sortedTable(
          Expression<R> row,
          GroupExpression<C, C2> column,
          Expression<V> value,
          Comparator<? super R> rowComparator,
          Comparator<? super C2> columnComparator) {
    return sortedTable(
  ...
  public static <R, C, V, R2, C2>
      AbstractGroupExpression<Triplet<R, C, V>, RowSortedTable<R2, C2, V>> sortedTable(
          ...
          Comparator<? super R2> rowComparator,
          Comparator<? super C2> columnComparator) {
    return sortedTable(row, column, new GOne<V>(value), rowComparator, columnComparator);
  }

  /**
   * @see #sortedTable(GroupExpression, GroupExpression, GroupExpression, Comparator, Comparator)
   */
  public static <R, C, V, V2>
      AbstractGroupExpression<Triplet<R, C, V>, RowSortedTable<R, C, V2>> sortedTable(
          Expression<R> row,
          Expression<C> column,
          GroupExpression<V, V2> value,
          Comparator<? super R> rowComparator,
          Comparator<? super C> columnComparator) {
    return sortedTable(
  ...
  public static <R, C, V, C2, V2>
      AbstractGroupExpression<Triplet<R, C, V>, RowSortedTable<R, C2, V2>> sortedTable(
          ...
          Comparator<? super R> rowComparator,
          Comparator<? super C2> columnComparator) {
    return sortedTable(new GOne<R>(row), column, value, rowComparator, columnComparator);
  }
