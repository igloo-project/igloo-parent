...
public class MigratedFromOldApplicationSequenceGenerator extends PredefinedIdSequenceGenerator {
  ...
  public static final String CLASS_NAME =
      "org.iglooproject.jpa.business.generic.model.migration.MigratedFromOldApplicationSequenceGenerator";
  ...
  public Object generate(SharedSessionContractImplementor session, Object obj) {
    if (obj instanceof IMigratedFromOldApplicationEntity) {
      IMigratedFromOldApplicationEntity<?> migratedEntity =
          (IMigratedFromOldApplicationEntity<?>) obj;
