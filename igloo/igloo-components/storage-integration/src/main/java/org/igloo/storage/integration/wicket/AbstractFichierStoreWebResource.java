...
public abstract class AbstractFichierStoreWebResource extends AbstractResource {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(AbstractFichierStoreWebResource.class);
	...
	protected ResourceResponse newResourceResponse(Attributes attributes) {
		...
		try {
			final FichierStoreResourceStream stream = getFileStoreResourceStream(attributes.getParameters());
