...
/**
 * For these tests, we perform a parameterized run, but supplier is null (as createModel, ...) do not use its value
 * and equivalence is either equal a custom ordered set implementation.
 */
