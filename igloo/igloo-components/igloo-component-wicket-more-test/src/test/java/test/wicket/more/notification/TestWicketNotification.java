...
class TestWicketNotification extends AbstractTestWicketNotification {
  ...
  @Autowired public INotificationContentDescriptorFactory notificationContentDescriptorFactory;
  ...
  void testWicketNotificationGroup() throws ServiceException {
    ...
    builder
        .toAddress("test-1@example.com", "test-2@example.com")
        .content(notificationContentDescriptorFactory.simpleContent("my content"))
        .send();
  ...
  /**
   * Check that locale=fr_CA and locale=fr_FR are grouped as they collapsed to the same available
   * locale (same prefix fr).
   */
  @Test
  ...
  /**
   * Check that locale=de and locale=fr_FR are grouped as 'de' is not available and is replaced by
   * default locale 'fr' and fr_FR is collapsed to 'fr'.
   */
  @Test
  ...
  /**
   * Check that locale=null and locale=en are splitted as default locale is not 'en', and 'en' is an
   * available locale.
   */
  @Test
  ...
  /**
   * Check that locale=fr_FR and locale=en_EN are splitted as they collapsed to different available
   * locales.
   */
  @Test
