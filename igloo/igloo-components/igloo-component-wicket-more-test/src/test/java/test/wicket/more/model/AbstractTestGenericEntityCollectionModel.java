...
public abstract class AbstractTestGenericEntityCollectionModel<C extends Collection<Person>>
  ...
  protected static final Equivalence<Set<?>> ORDERED_SET_EQUIVALENCE =
      new Equivalence<Set<?>>() {
        @Override
        protected boolean doEquivalent(Set<?> a, Set<?> b) {
          return Lists.newArrayList(a)
              .equals(
                  Lists.newArrayList(
                      b)); // SortedSet.equals won't work on cloned transient instances
        }
  ...
  @ParameterizedTest(name = "{index}: collectionSupplier={0}, equivalence={1}")
  @MethodSource("data")
  public void testAttachedWhenPersisted(
      SerializableSupplier2<? extends C> collectionSupplier, Equivalence<? super C> equivalence)
      throws Exception {
    Person person1 = new Person("John", "Doe");
    Person person2 = new Person("John2", "Doe2");
  ...
  @ParameterizedTest(name = "{index}: collectionSupplier={0}, equivalence={1}")
  @MethodSource("data")
  public void testAttachedWhenTransientAndDetachedWhenPersisted(
      SerializableSupplier2<? extends C> collectionSupplier, Equivalence<? super C> equivalence)
      throws Exception {
    Person person1 = new Person("John", "Doe");
    Person person2 = new Person("John2", "Doe2");
  ...
  @ParameterizedTest(name = "{index}: collectionSupplier={0}, equivalence={1}")
  @MethodSource("data")
  public void testAttachedWhenPersistedAndDetachedWhenTransient(
      SerializableSupplier2<? extends C> collectionSupplier, Equivalence<? super C> equivalence)
      throws Exception {
    Person person1 = new Person("John", "Doe");
    Person person2 = new Person("John2", "Doe2");
  ...
  @ParameterizedTest(name = "{index}: collectionSupplier={0}, equivalence={1}")
  @MethodSource("data")
  public void testDetachedWhenTransientThenDetachedWhenPersisted(
      SerializableSupplier2<? extends C> collectionSupplier, Equivalence<? super C> equivalence)
      throws Exception {
    Person person1 = new Person("John", "Doe");
    Person person2 = new Person("John2", "Doe2");
  ...
  @ParameterizedTest(name = "{index}: collectionSupplier={0}, equivalence={1}")
  @MethodSource("data")
  public void testCollectionGetObjectAdd(
      SerializableSupplier2<? extends C> collectionSupplier, Equivalence<? super C> equivalence)
      throws Exception {
    Person person1 = new Person("John", "Doe");
    Person person2 = new Person("John2", "Doe2");
    ...
    assertThat(
        model.getObject(),
        isEquivalent(equivalence, createCollection(collectionSupplier, person1, person2, person3)));
  ...
  @ParameterizedTest(name = "{index}: collectionSupplier={0}, equivalence={1}")
  @MethodSource("data")
  public void testCollectionGetObjectRemove(
      SerializableSupplier2<? extends C> collectionSupplier, Equivalence<? super C> equivalence)
      throws Exception {
    Person person1 = new Person("John", "Doe");
    Person person2 = new Person("John2", "Doe2");
    ...
    assertThat(
        model.getObject(),
        isEquivalent(equivalence, createCollection(collectionSupplier, person1)));
    ...
    assertThat(
        modelObject, isEquivalent(equivalence, createCollection(collectionSupplier, person1)));
  }
}
