...
public class TestGenericEntityKeyMapCopyModel<M extends Map<Person, ValueEnum>>
  ...
  public static Iterable<Object[]> data() {
    return Arrays.asList(
        new Object[][] {
          ...
          //				{ Suppliers2.treeMap(), Equivalence.equals() }, // Won't work since we have two
          // transient entities
  ...
  protected IMapModel<Person, ValueEnum, M> createModel(
      SerializableSupplier2<? extends M> mapSupplier) {
    return MapCopyModel.custom(
        mapSupplier,
        GenericEntityModel.<Person>factory(),
        Models.<ValueEnum>serializableModelFactory());
  }
  ...
  public void testGetObjectPut(
    ...
    assertThat(
        model.getObject(),
        isEquivalent(equivalence, createMap(mapSupplier, person1, person2, person3)));
  ...
  @ParameterizedTest(name = "{index}: collectionSupplier={0}, equivalence={1}")
  @MethodSource("data")
  public void testGetObjectRemove(
      SerializableSupplier2<? extends M> mapSupplier, Equivalence<? super M> equivalence)
      throws Exception {
    Person person1 = new Person("John", "Doe");
    Person person2 = new Person("John2", "Doe2");
