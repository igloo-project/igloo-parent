...
public class TestSerializableMapCopyModel<M extends Map<KeyEnum, ValueEnum>>
  ...
  protected IMapModel<KeyEnum, ValueEnum, M> createModel(
    ...
    return MapCopyModel.custom(
        mapSupplier,
        Models.<KeyEnum>serializableModelFactory(),
  ...
  public void testNull(
      SerializableSupplier2<? extends M> supplier, Equivalence<? super M> equivalence) {
  ...
  public void testGetObjectAdd(
    ...
    assertThat(
        model.getObject(),
        isEquivalent(equivalence, createMap(supplier, KeyEnum.KEY1, KeyEnum.KEY2, KeyEnum.KEY3)));
