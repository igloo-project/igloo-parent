...
import org.iglooproject.test.rest.jersey2.context.MockRestServer;
import org.iglooproject.test.rest.jersey2.context.RestServerTestExecutionListener;

@TestExecutionListeners(listeners = RestServerTestExecutionListener.class)
