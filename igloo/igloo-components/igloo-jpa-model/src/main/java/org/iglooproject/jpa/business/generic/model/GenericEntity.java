...
public abstract class GenericEntity<
  ...
  /**
   * This function allows to implement different behaviors based on Hibernate availability on
   * classpath. {@link Hibernate}.getClass(Object) is needed when we want to compare entity proxies.
   */
  static final Function<Object, Class<?>> GET_CLASS_FUNCTION;

  public static final GenericEntityImplementation IMPLEMENTATION;

  @Deprecated public static final String ID_SORT = "idSort";
  ...
  public static final Ordering<String> STRING_COLLATOR_FRENCH =
      new SerializableCollator(Locale.FRENCH).nullsLast();
  public static final Ordering<String> STRING_COLLATOR_ENGLISH =
      new SerializableCollator(Locale.ENGLISH).nullsLast();
  public static final Ordering<String> STRING_COLLATOR_ROOT =
      new SerializableCollator(Locale.ROOT).nullsLast();
  ...
  /**
   * DO NOT OVERRIDE THIS METHOD UNLESS YOU HAVE A VERY GOOD REASON FOR IT. Override {@link
   * #toStringHelper()} instead.
   */
  @Override
   ...
   *
   * <p>Note that, in some cases we <strong>do</strong> want to serialize persisted entities, for
   * instance when they are values of attributes of an entity which is in the process of being
   * created in a web form.
   */
  private void writeObject(ObjectOutputStream out) throws IOException {
    if (LOGGER.isDebugEnabled() && !isNew()) {
      LOGGER.debug("Serializing a persisted entity (class = {} and id = {})", getClass(), getId());
    }
