...
@Embeddable
@Bindable
public final class LongEntityReference extends GenericEntityReference<Long, GenericEntity<Long,?>> {
	...
	public static <E extends GenericEntity<Long, ?>> LongEntityReference
			of(Class<? extends E> entityClass, Long entityId) {
	...
	public LongEntityReference(GenericEntityReference<Long, ? extends GenericEntity<Long, ?>> genericEntityReference) {
