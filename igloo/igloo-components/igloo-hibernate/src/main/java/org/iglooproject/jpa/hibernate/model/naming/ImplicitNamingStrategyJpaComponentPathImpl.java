...
public class ImplicitNamingStrategyJpaComponentPathImpl
    extends ImplicitNamingStrategyJpaCompliantImpl {

  private static final long serialVersionUID = 6365899992934883501L;

  public static final ImplicitNamingStrategyJpaComponentPathImpl INSTANCE =
      new ImplicitNamingStrategyJpaComponentPathImpl();
