...
/**
 * @deprecated switch to {@link GenericReferenceDataSearchQueryImpl} that provides modern hibernate
 *     search DSL queries. You need to replace matchIf... API by hibernate search DSL query to
 *     perform the switch.
 */
...
public abstract class OldGenericReferenceDataSearchQueryImpl<
    ...
    extends OldAbstractHibernateSearchSearchQuery<T, S>
