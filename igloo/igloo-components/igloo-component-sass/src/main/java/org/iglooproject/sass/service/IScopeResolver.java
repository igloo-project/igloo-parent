...
public interface IScopeResolver {
	 ...
	 * 
	 * @param scoped url (<code>$(scope-NAME)/path/file</code> value). If url is not scoped, original url is returned.
	 * 
	 * @return original url if not scoped, else scopedUrl with scope replaced by classpath resource path.
	 * 
