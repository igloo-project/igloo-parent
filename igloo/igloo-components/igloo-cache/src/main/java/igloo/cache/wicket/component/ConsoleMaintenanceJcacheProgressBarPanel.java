...
public class ConsoleMaintenanceJcacheProgressBarPanel extends GenericPanel<Float> {
	...
	public ConsoleMaintenanceJcacheProgressBarPanel(String id, IModel<Float> valueModel, boolean sign, float low, float high) {
		super(id, valueModel);
