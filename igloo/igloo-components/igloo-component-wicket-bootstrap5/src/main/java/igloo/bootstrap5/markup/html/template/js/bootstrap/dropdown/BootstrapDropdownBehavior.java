...
public class BootstrapDropdownBehavior extends Behavior {
  ...
  public BootstrapDropdownBehavior(
      Component dropdownMenu, IModel<? extends IBootstrapDropdownOptions> optionsModel) {
    super();
  ...
  public void renderHead(Component component, IHeaderResponse response) {
    ...
    response.render(
        OnDomReadyHeaderItem.forScript(
            "new bootstrap.Dropdown(document.getElementById('"
                + component.getMarkupId()
                + "'), "
                + optionsModel.getObject().getJavaScriptOptions()
                + ");"));
  }
