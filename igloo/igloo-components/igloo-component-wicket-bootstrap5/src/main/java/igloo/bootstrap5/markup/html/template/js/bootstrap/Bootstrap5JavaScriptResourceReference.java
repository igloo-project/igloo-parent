...
public final class Bootstrap5JavaScriptResourceReference
  ...
  private static final SerializableSupplier2<List<HeaderItem>> DEPENDENCIES =
      WebjarUtil.memoizeHeaderItemsforReferences(PopperJavaScriptResourceReference.get());

  private static final Bootstrap5JavaScriptResourceReference INSTANCE =
      new Bootstrap5JavaScriptResourceReference();
