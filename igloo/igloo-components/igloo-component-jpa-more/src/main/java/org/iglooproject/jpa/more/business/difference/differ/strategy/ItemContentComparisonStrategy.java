...
public abstract class ItemContentComparisonStrategy {
  ...
  private static final ItemContentComparisonStrategy DEEP =
      new ItemContentComparisonStrategy() {
        @Override
        public DiffNode compareItem(
  ...
  private static final ItemContentComparisonStrategy SHALLOW =
      new ItemContentComparisonStrategy() {
        @Override
        public DiffNode compareItem(
            DifferDispatcher differDispatcher,
        ...
        private DiffNode compare(
          ...
          final DiffNode node =
              new DiffNode(parentNode, instances.getSourceAccessor(), instances.getType());
  ...
  public abstract DiffNode compareItem(
      DifferDispatcher differDispatcher,
      IsReturnableResolver isReturnableResolver,
      DiffNode parentNode,
      Instances parentInstances,
