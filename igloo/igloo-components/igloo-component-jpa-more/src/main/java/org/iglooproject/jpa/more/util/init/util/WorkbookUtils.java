...
public final class WorkbookUtils {
  ...
  private static final Set<FormulaFeature> ALLOWED_NOT_IMPLEMENTED_FORMULA_FEATURES =
      Sets.newHashSet();
  ...
  private static Object getCellValueFromFormula(FormulaEvaluator formulaEvaluator, Cell cell) {
    try {
      ...
      // we can retrieve the cached value (which may no longer be correct, depending of what you do
      // on your file).
