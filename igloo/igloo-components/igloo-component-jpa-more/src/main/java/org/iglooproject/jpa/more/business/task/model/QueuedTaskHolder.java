    ...
    return super.toStringHelper()
        ...
        .add(
            ...
            getCreationDate() != null
                ? dateFormat.format(getCreationDate().atZone(ZoneId.systemDefault()))
                : null)
        .add(
            "startDate",
            getStartDate() != null
                ? dateFormat.format(getStartDate().atZone(ZoneId.systemDefault()))
                : null)
        .add(
            "completionDate",
            getEndDate() != null
                ? dateFormat.format(getEndDate().atZone(ZoneId.systemDefault()))
                : null);
  }
}
