...
public interface IGenericReferenceDataSubService extends ITransactionalAspectAwareService {
	...
	<E extends GenericReferenceData<?, ?>> List<E> list(Class<E> clazz, Comparator<? super E> comparator);
	...
	<E extends GenericReferenceData<?, ?>> List<E> listEnabled(Class<E> clazz, Comparator<? super E> comparator);
