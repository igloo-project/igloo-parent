 ...
 */
package org.iglooproject.jpa.more.business.audit.service;
 ...
 */
public interface IAbstractAuditService<T extends AbstractAudit<?>> extends IGenericEntityService<Long, T> {
