...
@Service
public class GenericBasicReferenceDataServiceImpl implements IGenericBasicReferenceDataService {

	@Autowired
	private IGenericReferenceDataService genericReferenceDataService;

	@Autowired
	public GenericBasicReferenceDataServiceImpl(IGenericLocalizedReferenceDataDao referenceDataDao) {
		super();
	}
