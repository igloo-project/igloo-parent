...
public interface IGenericReferenceDataSubDao {
	...
	<E extends GenericReferenceData<?, ?>> List<E> list(Class<E> clazz, EnabledFilter enabledFilter, Comparator<? super E> comparator);
	...
	<E extends GenericReferenceData<?, ?>> List<E> list(EntityPath<E> entityPath, Long limit, Long offset);

	<E extends GenericReferenceData<?, ?>, V extends Comparable<?>> List<E> listByField(EntityPath<E> entityPath, SimpleExpression<V> field, V fieldValue, OrderSpecifier<?> orderSpecifier);

	<E extends GenericReferenceData<?, ?>, V extends Comparable<?>> List<E> listByField(EntityPath<E> entityPath, SimpleExpression<V> field, V fieldValue, Long limit, Long offset, OrderSpecifier<?> orderSpecifier);
