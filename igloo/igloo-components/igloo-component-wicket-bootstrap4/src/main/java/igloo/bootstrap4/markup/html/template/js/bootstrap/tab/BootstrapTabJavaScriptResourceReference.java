...
public final class BootstrapTabJavaScriptResourceReference
  ...
  private static final BootstrapTabJavaScriptResourceReference INSTANCE =
      new BootstrapTabJavaScriptResourceReference();

  private BootstrapTabJavaScriptResourceReference() {
    super("bootstrap4/current/js/dist/tab.js");
  }
