package igloo.bootstrap4.markup.html.template.js.bootstrap.modal.statement;
...
public final class BootstrapModal implements ChainableStatement, Serializable, IBootstrapModal {
  ...
  /**
   * If false, focus trap is deactivated (no effect as modal-more override _enforceFocus so it does
   * nothing. true of false value may not change observed behavior).
   */
