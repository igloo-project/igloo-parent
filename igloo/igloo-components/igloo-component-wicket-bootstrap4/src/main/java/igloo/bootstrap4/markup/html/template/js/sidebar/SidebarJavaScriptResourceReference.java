...
public final class SidebarJavaScriptResourceReference
    extends AbstractCoreJQueryPluginResourceReference {

  private static final long serialVersionUID = 4245186847401300556L;

  private static final SidebarJavaScriptResourceReference INSTANCE =
      new SidebarJavaScriptResourceReference();
