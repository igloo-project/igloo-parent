package org.iglooproject.wicket.bootstrap3.console.maintenance.infinispan.component;
...
import org.iglooproject.wicket.bootstrap3.console.maintenance.infinispan.form.ConsoleMaintenanceInfinispanRoleAssignPopup;
	...
	public ConsoleMaintenanceInfinispanRolesPanel(String id) {
		...
		add(
				DataTableBuilder.start(
						...
						.addActionColumn()
								.addAction(
										BootstrapRenderer.constant("console.maintenance.infinispan.roles.actions.assign", "fa fa-fw fa-exchange", BootstrapColor.PRIMARY),
								...
								.addConfirmAction(
										BootstrapRenderer.constant("console.maintenance.infinispan.roles.actions.delete", "fa fa-fw fa-times", BootstrapColor.DANGER)
								)
