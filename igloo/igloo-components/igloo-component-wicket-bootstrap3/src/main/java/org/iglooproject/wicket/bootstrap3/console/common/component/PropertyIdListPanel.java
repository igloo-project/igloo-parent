package org.iglooproject.wicket.bootstrap3.console.common.component;
...
import org.iglooproject.wicket.bootstrap3.console.common.form.PropertyIdEditPopup;
	...
	public PropertyIdListPanel(String id, IModel<? extends Collection<PropertyId<?>>> propertyIdsModel) {
		...
		add(
				DataTableBuilder.start(
						...
						.addActionColumn()
								.addAction(
										BootstrapRenderer.constant("common.propertyId.action.edit", "fa fa-fw fa-pencil", BootstrapColor.PRIMARY),
