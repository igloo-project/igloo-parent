...
public abstract class AbstractJpaCoreTestCase extends AbstractTestCase {
  ...
  @Autowired protected ICompanyService companyService;

  @Autowired protected IProjectService projectService;

  @Autowired protected IPersonService personService;

  @Autowired protected IPersonReferenceService personReferenceService;

  @Autowired protected ILabelService labelService;
