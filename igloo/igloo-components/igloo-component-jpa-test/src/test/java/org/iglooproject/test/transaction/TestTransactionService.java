 ...
 *
 * <p>Il est important que l'exécution des tests de cette classe soit hors transaction.
 *
 * @author Open Wide
 */
...
class TestTransactionService extends AbstractJpaCoreTestCase {
  ...
  @Autowired private ServiceExceptionService serviceExceptionService;
  ...
  void testReloadOnRollback() throws ServiceException, SecurityServiceException {
    ...
    try {
      ...
      fail(
          "Faire une opération sur un objet après un rollback lève une LazyInitializationException "
