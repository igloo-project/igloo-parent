...
public class PersonDaoImpl extends GenericEntityDaoImpl<Long, Person> implements IPersonDao {
  ...
  @Override
  public <T extends Person, V extends Comparable<?>> T getByField(
  ...
  @Override
  public <T extends Person, V extends Comparable<?>> List<T> listByField(
  ...
  public <V extends Comparable<?>> Long countByField(
      EntityPath<? extends Person> entityPath, SimpleExpression<V> field, V fieldValue) {
