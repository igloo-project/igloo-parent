...
public class BridgeEntity extends GenericEntity<Long, BridgeEntity> {
	...
	@ManyToOne
	@GenericField(valueBridge = @ValueBridgeRef(type = GenericEntityIdBridge.class), sortable = Sortable.YES)
	public BridgeLinkedEntity linked2;

	@Embedded
	@GenericField(valueBridge = @ValueBridgeRef(type = GenericEntityReferenceIdBridge.class), projectable = Projectable.YES)
