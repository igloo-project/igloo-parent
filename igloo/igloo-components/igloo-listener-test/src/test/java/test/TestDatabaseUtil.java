...
import igloo.test.listener.postgresql.DatabaseUtil;
...
/**
 * Test database truncate utils. Beware that {@link DatabaseUtil} and {@link
 * DatabaseIglooTestListener} are compatible only with postgresql.
 */
