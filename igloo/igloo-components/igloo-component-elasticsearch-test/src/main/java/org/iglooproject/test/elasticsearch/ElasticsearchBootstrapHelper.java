...
public final class ElasticsearchBootstrapHelper {
  ...
  public static EmbeddedElastic initializeEmbeddedElastic(
      String elasticVersion,
      Integer httpPort,
      Integer transportTcpPort,
      String clusterName,
      Integer startTimeout,
      TimeUnit startUnit) {
    return initializeEmbeddedElastic(
        elasticVersion, httpPort, transportTcpPort, clusterName, startTimeout, startUnit, null);
  }
