...
public class StorageFailure extends GenericEntity<Long, StorageFailure> {
  ...
  public static StorageFailure ofMissingEntity(
      String path, StorageConsistencyCheck consistencyCheck) {
  ...
  public static StorageFailure ofMissingFile(
      Path path, Fichier fichier, StorageConsistencyCheck consistencyCheck) {
    StorageFailure failure = new StorageFailure();
  ...
  public static StorageFailure ofSizeMismatch(
      Path path, Fichier fichier, StorageConsistencyCheck consistencyCheck) {
    StorageFailure failure = new StorageFailure();
    failure.setPath(path.toString());
    failure.setFichier(fichier);
  ...
  public static StorageFailure ofChecksumMismatch(
      Path path, Fichier fichier, StorageConsistencyCheck consistencyCheck) {
    StorageFailure failure = new StorageFailure();
    failure.setPath(path.toString());
    failure.setFichier(fichier);
