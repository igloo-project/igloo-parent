...
@Entity
public class StorageConsistencyCheck extends GenericEntity<Long, StorageConsistencyCheck>
  ...
  /**
   * Storage unit targetted by this check. Listings are performed on entity linked with this {@link
   * StorageUnit} and filesystem content in {@link StorageUnit} directory (see {@link
   * StorageUnit#getPath()}).
   */
  @ManyToOne private StorageUnit storageUnit;
  ...
  /**
   * Check end time. Set to start time during check processing; must not be visible outside
   * transaction.
   */
  @Basic(optional = false)
  @Column(nullable = false)
  ...
  @Basic private Integer fsFileCount;

  @Basic private Long fsFileSize;

  @Basic private Integer dbFichierCount;

  @Basic private Long dbFichierSize;

  @Basic private Integer missingFileCount;

  @Basic private Integer missingFichierCount;

  @Basic private Integer sizeMismatchCount;

  @Basic private Integer checksumMismatchCount;
