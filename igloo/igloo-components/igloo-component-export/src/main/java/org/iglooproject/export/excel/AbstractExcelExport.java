...
/**
 * Classe abstraite permettant de construire un document Excel.
 *
 * @author Open Wide
 */
public abstract class AbstractExcelExport {
  ...
  protected final void setStyleFillForegroundColor(
      CellStyle style, Map<Short, Color> colorRegistry, short color) {
  ...
  protected final void setStyleFillBackgroundColor(
      CellStyle style, Map<Short, Color> colorRegistry, short color) {
    if (style instanceof XSSFCellStyle && colorRegistry.containsKey(color)) {
  ...
  protected final void setStyleTopBorderColor(
      CellStyle style, Map<Short, Color> colorRegistry, short color) {
    if (style instanceof XSSFCellStyle && colorRegistry.containsKey(color)) {
  ...
  protected final void setStyleBottomBorderColor(
      CellStyle style, Map<Short, Color> colorRegistry, short color) {
    if (style instanceof XSSFCellStyle && colorRegistry.containsKey(color)) {
  ...
  protected final void setStyleLeftBorderColor(
      CellStyle style, Map<Short, Color> colorRegistry, short color) {
    if (style instanceof XSSFCellStyle && colorRegistry.containsKey(color)) {
  ...
  protected final void setStyleRightBorderColor(
      CellStyle style, Map<Short, Color> colorRegistry, short color) {
    if (style instanceof XSSFCellStyle && colorRegistry.containsKey(color)) {
  ...
  protected XSSFColor fromAwtColor(Map<Short, Color> colorRegistry, short color) {
    ...
    xssfColor.setRGB(
        new byte[] {
          (byte) awtColor.getRed(), (byte) awtColor.getGreen(), (byte) awtColor.getBlue()
        });
    return xssfColor;
  }
