...
public class IglooFlywayAutoConfiguration {
  ...
  /**
   * {@link JavaMigration} bean scanning and <code>spring.flyway.locations</code> definition for
   * init-less migration.
   *
   * <p>Active only when migration.init.enabled=false or missing.
   */
  @Configuration
  ...
  /**
   * {@link JavaMigration} bean scanning and <code>spring.flyway.locations</code> definition for
   * init-aware migration.
   *
   * <p>Bean scanning is configured on <code>db.migration</code> package, so that it captures both
   * common and init subpackages.
   *
   * <p>Active only when migration.init.enabled=false or missing.
   */
  @Configuration
