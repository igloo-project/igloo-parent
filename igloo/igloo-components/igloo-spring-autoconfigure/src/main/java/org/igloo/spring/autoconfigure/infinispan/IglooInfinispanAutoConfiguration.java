package org.igloo.spring.autoconfigure.infinispan;
...
import org.iglooproject.jpa.more.config.spring.JpaMoreInfinispanPropertyRegistryConfig;
...
@Import({ JpaMoreInfinispanPropertyRegistryConfig.class })
public class IglooInfinispanAutoConfiguration {
