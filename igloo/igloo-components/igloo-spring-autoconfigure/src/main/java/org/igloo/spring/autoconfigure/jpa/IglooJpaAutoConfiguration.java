...
public class IglooJpaAutoConfiguration {
  ...
  /**
   * Ensure that dataSource is correctly destroyed on context destruction with an explicit
   * configuration. (Spring should automatically call close method on beans)
   */
   ...
   * Spring components that want to initialize some beans before entity manager creation must
   * redefine this bean (databaseInitialization) and perform their initialization step before its
   * creation.
   *
  ...
  public LocalContainerEntityManagerFactoryBean entityManagerFactory(
      IJpaConfigurationProvider defaultJpaCoreConfigurationProvider) {
