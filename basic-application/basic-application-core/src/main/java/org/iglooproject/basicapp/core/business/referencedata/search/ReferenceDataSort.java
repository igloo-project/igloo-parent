...
public enum ReferenceDataSort implements ISort<SortField> {
  ...
  POSITION {
    ...
    public List<SortField> getSortFields(SortOrder sortOrder) {
      return ImmutableList.of(
          SortUtils.luceneSortField(this, sortOrder, SortField.Type.INT, ReferenceData.POSITION));
    }
    ...
    public List<SortField> getSortFields(SortOrder sortOrder) {
      return ImmutableList.of(
          SortUtils.luceneSortField(
              this, sortOrder, SortField.Type.STRING, ReferenceData.CODE_SORT));
    }
  ...
  LABEL_FR {
    ...
    public List<SortField> getSortFields(SortOrder sortOrder) {
      return ImmutableList.of(
          SortUtils.luceneSortField(
              this, sortOrder, SortField.Type.STRING, ReferenceData.LABEL_FR_SORT));
    }
  ...
  LABEL_EN {
    ...
    public List<SortField> getSortFields(SortOrder sortOrder) {
      return ImmutableList.of(
          SortUtils.luceneSortField(
              this, sortOrder, SortField.Type.STRING, ReferenceData.LABEL_EN_SORT));
    }
