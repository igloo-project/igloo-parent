...
public class AbstractBasicApplicationMain {
  ...
  protected AnnotationConfigApplicationContext initializeContext(
      String iglooProfile, Class<?> configClass) {
    AnnotationConfigApplicationContext context = new AnnotationConfigApplicationContext();
    Map<String, Object> ps =
        ImmutableMap.<String, Object>builder()
            .put(IApplicationContextInitializer.IGLOO_PROFILE_PROPERTY, iglooProfile)
            .build();
    context
        .getEnvironment()
        .getPropertySources()
  ...
  protected AnnotationConfigApplicationContext startContext(
      String iglooProfile, Class<?> configClass) {
