...
create sequence Country_id_seq start with 1 increment by 50;
...
create table Country (id bigint not null, deleteable boolean not null, disableable boolean not null, editable boolean not null, enabled boolean not null, position integer not null, label_en varchar(255), label_fr varchar(255), primary key (id));
