...
create table basic_application.Parameter (id int8 not null, booleanValue boolean, dateValue timestamp, floatValue float4, integerValue int4, name text not null, stringValue text, primary key (id));
