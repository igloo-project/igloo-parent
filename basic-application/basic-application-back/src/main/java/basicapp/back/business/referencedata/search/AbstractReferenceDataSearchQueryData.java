...
public abstract class AbstractReferenceDataSearchQueryData<T extends ReferenceData<? super T>> implements ISearchQueryData<T>, IAbstractBasicReferenceDataSearchQueryDataBindingInterface {
