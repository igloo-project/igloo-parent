...
public interface IUserControllerService {
  ...
  void affectRoles(@Nonnull @PermissionObject User user)
      throws SecurityServiceException, ServiceException;

  @PreAuthorize(USER_BASIC_WRITE)
  void saveBasicUser(@Nonnull @PermissionObject User user, String password)
      throws SecurityServiceException, ServiceException;

  @PreAuthorize(USER_TECHNICAL_WRITE)
  void saveTechnicalUser(@Nonnull @PermissionObject User user, String password)
      throws SecurityServiceException, ServiceException;
