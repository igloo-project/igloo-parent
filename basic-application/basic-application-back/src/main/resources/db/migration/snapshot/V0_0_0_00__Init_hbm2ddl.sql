...
create table Announcement (id bigint not null, content_en text, content_fr text, creation_date timestamp(6) with time zone not null, creation_subject_label text, creation_subject_reference_id bigint, creation_subject_reference_type varchar(255), creation_subject_serialized text, enabled boolean not null, modification_date timestamp(6) with time zone not null, modification_subject_label text, modification_subject_reference_id bigint, modification_subject_reference_type varchar(255), modification_subject_serialized text, publication_endDateTime timestamp(6) not null, publication_startDateTime timestamp(6) not null, type varchar(255) not null check ((type in ('NOTIFICATION','UNAVAILABILITY'))), unavailability_endDateTime timestamp(6), unavailability_startDateTime timestamp(6), primary key (id));
