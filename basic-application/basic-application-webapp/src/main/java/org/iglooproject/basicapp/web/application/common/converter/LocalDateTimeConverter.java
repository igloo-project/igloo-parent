...
public class LocalDateTimeConverter extends org.apache.wicket.util.convert.converter.LocalDateTimeConverter {

	private static final long serialVersionUID = -4412976316698853032L;

	private static final LocalDateTimeConverter INSTANCE = new LocalDateTimeConverter(DateTimePattern.SHORT_DATETIME);
