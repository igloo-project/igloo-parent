...
public class ConsoleNotificationDemoPage extends ConsoleNotificationDemoTemplate {
	...
	public ConsoleNotificationDemoPage(PageParameters parameters, IModel<INotificationContentDescriptor> descriptorModel) {
		super(parameters);
			...
			new Form<>("form")
				.add(
					new LocaleDropDownChoice("locale", localeModel)
						.setLabel(new ResourceModel("console.notifications.demo.locale"))
						.setRequired(true)
						.add(
