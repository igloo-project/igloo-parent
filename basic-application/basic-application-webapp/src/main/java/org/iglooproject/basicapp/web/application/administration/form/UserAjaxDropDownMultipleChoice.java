...
public class UserAjaxDropDownMultipleChoice<U extends User, C extends Collection<U>> extends GenericSelect2AjaxDropDownMultipleChoice<U> {
	...
	public UserAjaxDropDownMultipleChoice(String id, IModel<C> model, Supplier<? extends C> collectionSupplier, Class<U> targetTypeClass) {
		this(id, model, collectionSupplier, targetTypeClass, targetTypeClass);
	}

	public UserAjaxDropDownMultipleChoice(String id, IModel<C> model, Supplier<? extends C> collectionSupplier, Class<U> targetTypeClass, Class<? extends U> searchTypeClass) {
		this(id, model, collectionSupplier, new ChoiceProvider<>(targetTypeClass, searchTypeClass));
	}

	public UserAjaxDropDownMultipleChoice(String id, IModel<C> model, Supplier<? extends C> collectionSupplier, ChoiceProvider<U> choiceProvider) {
