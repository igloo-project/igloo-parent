...
import org.iglooproject.basicapp.core.business.announcement.search.AnnouncementDtoSearch;
...
public class AnnouncementDataProvider extends SearchQueryDataProvider<Announcement, AnnouncementSort, AnnouncementDtoSearch, IAnnouncementSearchQuery> {
	...
	public AnnouncementDataProvider() {
		super(new DataModel<>(AnnouncementDtoSearch::new));
	}
