  ...
  protected Component createHeader(String wicketId) {
    return new CoreLabel(
        ...
        addModeCondition()
            ...
            .otherwise(
                new StringResourceModel("administration.user.action.edit.title", getModel())));
  }
              ...
              if (addModeCondition().applies()) {
                ...
                if (StringUtils.hasText(password)) {
                  securityManagementService.updatePassword(
                      user, password, BasicApplicationSession.get().getUser());
                } else {
                  ...
                  Session.get()
                      .success(getString("administration.user.action.add.success.notification"));
                }
