...
import org.iglooproject.basicapp.web.application.referencedata.component.BasicReferenceDataListPanel;
	...
	public ReferenceDataPage(PageParameters parameters) {
		...
		add(
			new NavTabsPanel("tabs")
				...
				.add(
					new NavTabsPanel.SimpleTabFactory("country", "business.country") {
						private static final long serialVersionUID = 1L;
						@Override
						public Component createContent(String wicketId) {
							return new BasicReferenceDataListPanel<>(wicketId, Country::new, Country.class);
						}
					}
				)
		);
