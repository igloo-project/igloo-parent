...
public class ConsoleNotificationDemoIndexPage extends ConsoleNotificationDemoTemplate {
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(ConsoleNotificationDemoIndexPage.class);
    ...
    add(
        new SpecificModelCollectionView<INotificationContentDescriptor, NotificationDemoEntry>(
          ...
          protected void populateItem(SpecificModelItem item) {
            ...
            Condition.collectionModelNotEmpty(SequenceProviders.fromItemModels(createDemoEntries()))
                .thenShow()));
        ...
        new PlaceholderContainer("emptyList")
            .condition(
                Condition.collectionModelNotEmpty(
                    SequenceProviders.fromItemModels(createDemoEntries()))));
  }
    ...
    return Lists.<NotificationDemoEntry>newArrayList(
        new NotificationDemoEntry("example") {
          ...
          public INotificationContentDescriptor getDescriptor() {
            return descriptorService.example(
                getFirstInRange(User.class, DEFAULT_ID_RANGE), new Date());
          }
        }
