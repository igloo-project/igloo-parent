...
class ProfilePageTestCase extends AbstractBasicApplicationFrontTestCase {
  ...
  void updatePasswordPanelComponents() throws ServiceException, SecurityServiceException {
    ...
    Component container =
        tester.getComponentFromLastRenderedPage("description:passwordEditPopup:container");
  ...
  void updatePasswordFormMissingRequiredFields() throws ServiceException, SecurityServiceException {
    ...
    Component submitButton =
        tester.getComponentFromLastRenderedPage(passwordEditPopupPath() + ":footer:save");
  ...
  void updatePasswordFormSuccess() throws ServiceException, SecurityServiceException {
    ...
    tester.assertFeedbackMessages(
        new ExactLevelFeedbackMessageFilter(FeedbackMessage.SUCCESS), localize("common.success"));

    assertTrue(
        passwordEncoder.matches(
            newPassword, userService.getByUsername("basicUser").getPasswordHash()));
  }
