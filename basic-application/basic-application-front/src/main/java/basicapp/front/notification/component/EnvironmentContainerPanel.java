...
public class EnvironmentContainerPanel extends Panel {
	...
	private static final List<Environment> ENVIRONMENTS_SHOW = List.of(Environment.development, Environment.testing, Environment.staging);
	...
	public EnvironmentContainerPanel(String id, IModel<Environment> environmentModel) {
		...
		add(
			Condition.contains(() -> ENVIRONMENTS_SHOW, environmentModel)
				.thenShow()
		);
	}
