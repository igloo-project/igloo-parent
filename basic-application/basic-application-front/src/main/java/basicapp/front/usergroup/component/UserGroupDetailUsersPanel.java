package basicapp.front.usergroup.component;
  ...
  public UserGroupDetailUsersPanel(String id, final IModel<UserGroup> userGroupModel) {
    ...
    add(
        DataTableBuilder.start(dataProvider, dataProvider.getSortModel())
            ...
            .withLink(UserDetailTemplate.mapper().setParameter2(new ComponentPageModel(this)))
                    ...
                    protected void onSubmit(AjaxRequestTarget target) {
                      ...
                      if (user != null) {
                        if (!user.getGroups().contains(userGroup)) {
                          ...
                          LOGGER.error("User already in this user group.");
                          Session.get()
                              .warn(getString("userGroup.detail.users.add.error.duplicate"));
                        }
                      }
