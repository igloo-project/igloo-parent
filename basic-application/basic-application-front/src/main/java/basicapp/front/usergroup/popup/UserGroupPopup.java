package basicapp.front.usergroup.popup;
...
import basicapp.front.usergroup.model.RoleDataProvider;
...
public class UserGroupPopup extends AbstractAjaxModalPopupPanel<UserGroup> {
  ...
  protected Component createHeader(String wicketId) {
    return new CoreLabel(
        wicketId,
        addModeCondition()
            .then(new ResourceModel("userGroup.add.title"))
            .otherwise(new StringResourceModel("userGroup.edit.title", getModel())));
  }
  ...
  protected Component createBody(String wicketId) {
    ...
    form.add(
        new RequiredTextField<String>(
                "name", BindingModel.of(getModel(), Bindings.userGroup().name()))
            .setLabel(new ResourceModel("business.userGroup.name")),
        new TextArea<String>(
                "description", BindingModel.of(getModel(), Bindings.userGroup().description()))
            .setLabel(new ResourceModel("business.userGroup.description")),
        new CheckGroup<Authority>(
                "authorities",
          ...
          protected void onSubmit(AjaxRequestTarget target) {
            try {
              ...
              if (addModeCondition().applies()) {
                ...
                throw UserGroupDetailPage.linkDescriptor(
                        UserGroupPopup.this.getModel(), PageModel.of(getPage()))
