...
public abstract class ConsoleNotificationDemoEntry implements IModel<INotificationContentDescriptor> {
	...
	public IModel<String> getLabelModel() {
		return new ResourceModel("console.notification.demo.entry.label." + messageKeySuffix, messageKeySuffix);
	}
