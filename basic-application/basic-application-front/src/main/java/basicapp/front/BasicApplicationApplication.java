	...
	public void init() {
		...
		if (!propertyService.isConfigurationTypeDevelopment()) {
			preloadStyleSheets(
				...
				basicapp.front.common.template.resources.styles.application.application.applicationbasic.StylesScssResourceReference.get(),
				basicapp.front.common.template.resources.styles.application.application.applicationadvanced.StylesScssResourceReference.get()
			);
		}
