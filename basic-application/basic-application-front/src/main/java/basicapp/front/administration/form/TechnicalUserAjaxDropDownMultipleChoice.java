...
public class TechnicalUserAjaxDropDownMultipleChoice<C extends Collection<TechnicalUser>> extends GenericSelect2AjaxDropDownMultipleChoice<TechnicalUser> {

	private static final long serialVersionUID = 7076114890845943476L;

	public TechnicalUserAjaxDropDownMultipleChoice(String id, IModel<C> model, SerializableSupplier2<? extends C> collectionSupplier) {
		this(id, model, collectionSupplier, new ChoiceProvider());
	}

	public TechnicalUserAjaxDropDownMultipleChoice(String id, IModel<C> model, SerializableSupplier2<? extends C> collectionSupplier, org.wicketstuff.select2.ChoiceProvider<TechnicalUser> choiceProvider) {
