...
public class BasicUserDataProvider
    extends SearchQueryDataProvider<
        BasicUser, BasicUserSort, BasicUserSearchQueryData, IBasicUserSearchQuery> {

  private static final long serialVersionUID = 1L;

  @SpringBean private IBasicUserSearchQuery searchQuery;

  private final CompositeSortModel<BasicUserSort> sortModel =
      new CompositeSortModel<>(
          ...
          ImmutableMap.of(BasicUserSort.ID, BasicUserSort.ID.getDefaultOrder()));
  ...
  public BasicUserDataProvider(
      UnaryOperator<DataModel<BasicUserSearchQueryData>> dataModelOperator) {
    this(
