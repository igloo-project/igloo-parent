...
public class AdministrationUserGroupListPage extends AdministrationUserGroupTemplate {
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(AdministrationUserGroupListPage.class);

  public static final IPageLinkDescriptor linkDescriptor() {
    return LinkDescriptorBuilder.start().page(AdministrationUserGroupListPage.class);
  }
  ...
  public AdministrationUserGroupListPage(PageParameters parameters) {
    ...
    add(
        DataTableBuilder.start(
            ...
            .withLink(
                AdministrationUserGroupDetailPage.MAPPER_SOURCE.setParameter2(
                    new ComponentPageModel(this)))
