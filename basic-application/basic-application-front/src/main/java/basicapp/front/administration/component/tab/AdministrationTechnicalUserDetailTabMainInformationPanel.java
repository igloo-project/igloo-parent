...
public class AdministrationTechnicalUserDetailTabMainInformationPanel
    extends GenericPanel<TechnicalUser> {

  private static final long serialVersionUID = -6822072984820432812L;

  public AdministrationTechnicalUserDetailTabMainInformationPanel(
      String id, IModel<TechnicalUser> userModel) {
    super(id, userModel);
