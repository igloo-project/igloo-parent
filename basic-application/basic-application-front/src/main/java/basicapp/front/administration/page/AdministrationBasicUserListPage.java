...
import basicapp.front.administration.component.BasicUserListSearchPanel;
import basicapp.front.administration.export.UserExcelTableExport;
import basicapp.front.administration.form.BasicUserPopup;
import basicapp.front.administration.model.BasicUserDataProvider;
...
public class AdministrationBasicUserListPage extends AdministrationUserListTemplate<BasicUser> {
  ...
  public static final IPageLinkDescriptor linkDescriptor() {
    return LinkDescriptorBuilder.start().page(AdministrationBasicUserListPage.class);
  }
  ...
  public AdministrationBasicUserListPage(PageParameters parameters) {
    ...
    addBreadCrumbElement(
        new BreadCrumbElement(new ResourceModel("navigation.administration.user.basicUser")));
