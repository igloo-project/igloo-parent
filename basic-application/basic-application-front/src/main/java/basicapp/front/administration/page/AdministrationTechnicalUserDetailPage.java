...
import basicapp.front.administration.component.tab.AdministrationTechnicalUserDetailTabMainInformationPanel;
import basicapp.front.administration.component.tab.AdministrationTechnicalUserDetailTabSecurityPanel;
...
public class AdministrationTechnicalUserDetailPage
    extends AdministrationUserDetailTemplate<TechnicalUser> {

  private static final long serialVersionUID = -446179167337478755L;

  private static final Logger LOGGER =
      LoggerFactory.getLogger(AdministrationTechnicalUserDetailPage.class);

  public static final ITwoParameterLinkDescriptorMapper<IPageLinkDescriptor, TechnicalUser, Page>
      MAPPER = AdministrationUserDetailTemplate.mapper(TechnicalUser.class);
  ...
  public AdministrationTechnicalUserDetailPage(PageParameters parameters) {
    ...
    Component backToSourcePage =
        LinkFactory.get()
            .linkGenerator(sourcePageModel, AdministrationTechnicalUserListPage.class)
    ...
    add(
        BootstrapTabsUtils.build(
            ...
            new AdministrationTechnicalUserDetailTabMainInformationPanel(
                "mainInformation", userModel),
            () -> true));
