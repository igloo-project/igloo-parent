...
public class BasicUserAjaxDropDownMultipleChoice<C extends Collection<BasicUser>>
    extends GenericSelect2AjaxDropDownMultipleChoice<BasicUser> {

  private static final long serialVersionUID = 7076114890845943476L;

  public BasicUserAjaxDropDownMultipleChoice(
