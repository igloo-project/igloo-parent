...
import basicapp.front.user.component.tab.TechnicalUserDetailTabGeneralPanel;
import basicapp.front.user.component.tab.TechnicalUserDetailTabHistoryPanel;
