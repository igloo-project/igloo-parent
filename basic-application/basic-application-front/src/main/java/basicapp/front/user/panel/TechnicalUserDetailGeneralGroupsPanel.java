...
public class TechnicalUserDetailGeneralGroupsPanel extends GenericPanel<TechnicalUser> {

  private static final long serialVersionUID = 7856143985509286978L;

  private static final Logger LOGGER =
      LoggerFactory.getLogger(TechnicalUserDetailGeneralGroupsPanel.class);
  ...
  public TechnicalUserDetailGeneralGroupsPanel(String id, final IModel<TechnicalUser> userModel) {
    super(id, userModel);
  ...
  private class UserGroupAddFragment extends Fragment {
    ...
    public UserGroupAddFragment(String id, IModel<? extends TechnicalUser> userModel) {
      super(id, "addGroup", TechnicalUserDetailGeneralGroupsPanel.this);
