...
public class TestDatePickerPage extends MainTemplate {
  ...
  public TestDatePickerPage(PageParameters parameters) {
    ...
    //        .getJsBuilder()
    //        .onUpdateModel(
    //            JsLiteral.of("value => %s.value =
    // value".formatted(datePickerJsChange2.getVModel())));
    //    datePickerJsChange2
    //        .getJsBuilder()
    //        .onUpdateModel(
    //            JsLiteral.of("value => %s.value =
    // value".formatted(datePickerJsChange1.getVModel())));
    add(
        form.add(
            ...
            //                .setSelectText(new
            // ResourceModel("tips.forms.datepickers.selectionner"))
            ...
            new DatePickerRangeVueField("datepickerRange2", dateRange1Model, dateRange2Model)
                .setSelectText(new ResourceModel("tips.forms.datepickers.selectionner"))
                .setCancelText(new ResourceModel("tips.forms.datepickers.annuler"))
                .setLabel(new ResourceModel("tips.forms.datepickers.projet.dates")),
            ...
            //                .setLabel(new
            // ResourceModel("tips.forms.datepickers.projet.dateTime")),
            ...
            //                    yearModel,
            //                    builder ->
            // builder.yearPicker(JsHelpers.of(true)).format(JsHelpers.of("yyyy")))
            ...
            //                        builder
            //                            .minDate(
            //                                JsHelpers.ofLiteral("new Date().setDate(new
            // Date().getDate() - 5)"))
            //                            .maxDate(
            //                                JsHelpers.ofLiteral(
            ...
            //                .setLabel(new
            // ResourceModel("tips.forms.datepickers.format.restreint")),
            //            new DatePickerVueField(
            ...
            //                                  Map<String, Component> map, AjaxRequestTarget
            // target) {
            //
            ...
            //                              }
            //                            })),
            //            datePickerJsChange1.setLabel(new
            // ResourceModel("tips.forms.datepickers.dateRdv")),
            //            datePickerJsChange2.setLabel(new
            // ResourceModel("tips.forms.datepickers.dateRdv")),
            //            new DatePickerVueField(
            //                    "datePickerMarkers",
            //                    dateMarkers,
  ...
  public void renderHead(IHeaderResponse response) {
    ...
    response.render(
        JavaScriptHeaderItem.forReference(
            new JavaScriptResourceReference(TestDatePickerPage.class, "TestDatePickerPage.js")));
