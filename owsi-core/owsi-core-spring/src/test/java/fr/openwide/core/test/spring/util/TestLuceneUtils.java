...
public class TestLuceneUtils {
	...
	public void testGetAutocompleteQuery() {
		assertEquals("", LuceneUtils.getAutocompleteQuery(null));
	...
	public void testGetSimilarityQuery() {
		assertEquals("", LuceneUtils.getSimilarityQuery(null, 0.7f));
		...
		assertEquals("alfresco~0.7 sha1~0.7", LuceneUtils.getAutocompleteQuery("alfresco sha1"));
