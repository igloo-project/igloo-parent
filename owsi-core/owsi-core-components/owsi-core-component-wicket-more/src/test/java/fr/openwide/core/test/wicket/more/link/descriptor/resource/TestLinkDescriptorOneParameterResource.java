package fr.openwide.core.test.wicket.more.link.descriptor.resource;
...
public class TestLinkDescriptorOneParameterResource extends AbstractResource {
	...
	public static final ResourceReference REFERENCE =
			new ResourceReference(TestLinkDescriptorOneParameterResource.class, "TestLinkDescriptorResource1") {
				private static final long serialVersionUID = 1L;
				@Override
