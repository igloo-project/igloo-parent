...
public class ActionColumnBuilder<T, S extends ISort<?>> implements IActionColumnBuildState<T, S> {
	...
	private abstract class ActionColumnBuilderWrapper implements IActionColumnBuildState<T, S> {
		...
		@Override
		public IActionColumnAddedLinkState<T, S> addLink(BootstrapLabelRenderer<? super T> renderer,
				IOneParameterLinkDescriptorMapper<? extends ILinkGenerator, T> mapper) {
			return ActionColumnBuilder.this.addLink(renderer, mapper);
		}
		
		@Override
		public <C> IActionColumnAddedLinkState<T, S> addLink(BootstrapLabelRenderer<? super T> renderer,
		...
		@Override
		public IActionColumnAddedLinkState<T, S> addLabelledLink(BootstrapLabelRenderer<? super T> renderer,
				IOneParameterLinkDescriptorMapper<? extends ILinkGenerator, T> mapper) {
			return ActionColumnBuilder.this.addLabelledLink(renderer, mapper);
		}
		
		@Override
		public <C> IActionColumnAddedLinkState<T, S> addLabelledLink(BootstrapLabelRenderer<? super T> renderer,
				AbstractCoreBinding<? super T, C> binding,
				IOneParameterLinkDescriptorMapper<? extends ILinkGenerator, C> mapper) {
		...
		@Override
		public IActionColumnAddedActionState<T, S> addAction(BootstrapLabelRenderer<? super T> renderer,
				IAjaxOneParameterAjaxAction<IModel<T>> action) {
			return ActionColumnBuilder.this.addAction(renderer, action);
		}
		
		@Override
		public IActionColumnAddedActionState<T, S> addLabelledAction(BootstrapLabelRenderer<? super T> renderer,
				IAjaxOneParameterAjaxAction<IModel<T>> action) {
			return ActionColumnBuilder.this.addLabelledAction(renderer, action);
		}
		
		@Override
		public ActionColumnConfirmActionBuilder<T, S> addConfirmAction(BootstrapLabelRenderer<? super T> renderer) {
	...
	private class ActionColumnAddedActionState extends ActionColumnAddedElementState<IActionColumnAddedActionState<T, S>>
		...
		public ActionColumnAddedActionState(ActionColumnAjaxActionFactory<T> factory) {
			super();
			this.factory = Objects.requireNonNull(factory);
		}
	...
	public IActionColumnAddedConfirmActionState<T, S> addConfirmAction(BootstrapLabelRenderer<? super T> renderer,
