package fr.openwide.core.wicket.more.markup.html.form.observer;
...
public interface IFormComponentChangeObservable {
	...
	/**
	 * @return True if the observed form component is being submitted via Ajax using the observer mechanism (in the current request cycle).
	 */
