...
public class SimpleMandatoryCollectionLinkParameterValidator implements ILinkParameterValidator {
	...
	public SimpleMandatoryCollectionLinkParameterValidator(String parameterName, IModel<? extends Collection> parameterModel) {
	...
	public void validateModel(LinkParameterValidationErrorCollector collector) {
		for (IModel<? extends Collection> parameterModel : parameterModels) {
			...
			if (object == null || object.isEmpty()) {
				collector.addError(String.format("A mandatory parameter model object for parameter names '%s' was null or empty.", parameterNames));
			}
		}
	}
