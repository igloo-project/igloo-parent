...
public class ActionColumnConfirmActionFactory<T> extends AbstractActionColumnElementFactory<T, ActionColumnConfirmActionFactory<T>> {
	...
	public ActionColumnConfirmActionFactory(BootstrapLabelRenderer<? super T> renderer, IOneParameterComponentFactory<AjaxConfirmLink<T>, IModel<T>> ajaxConfirmLinkFactory) {
		super(renderer);
