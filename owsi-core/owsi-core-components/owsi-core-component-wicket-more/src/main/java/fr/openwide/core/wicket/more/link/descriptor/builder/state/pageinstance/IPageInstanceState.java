...
public interface IPageInstanceState<TLinkDescriptor extends IPageLinkGenerator>
	...
	/**
	 * Add a validator to the resulting link descriptor that will pass validation if the target page is an instance of
	 * the given class (or any other class passed to this method), and raise an error otherwise.
	...
	/**
	 * Similar to {@link #validate(Class)}, except the class that the target page should be an instance of is contained
	 * in a model, which allows for dynamic constraint on the target page class.
	 * @param expectedPageClassModel The model containing the class that the target page should be an instance of.
	 * @return The same builder for chaining calls.
	 */
