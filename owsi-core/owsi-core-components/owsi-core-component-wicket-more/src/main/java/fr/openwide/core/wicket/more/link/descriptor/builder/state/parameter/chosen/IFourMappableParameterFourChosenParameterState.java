...
import fr.openwide.core.wicket.more.link.descriptor.builder.state.parameter.chosen.common.IFourChosenParameterState;

public interface IFourMappableParameterFourChosenParameterState
		<
		TInitialState,
