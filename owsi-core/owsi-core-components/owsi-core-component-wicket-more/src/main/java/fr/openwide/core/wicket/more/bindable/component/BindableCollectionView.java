 ...
 * If you want to use a custom subtype of yours, go with {@link SpecificModelCollectionView} directly.
 * 
 * @author yrodiere
 *
 * @param <T>
 ...
 */
public abstract class BindableCollectionView<T> extends SpecificModelCollectionView<T, IBindableModel<T>> {
