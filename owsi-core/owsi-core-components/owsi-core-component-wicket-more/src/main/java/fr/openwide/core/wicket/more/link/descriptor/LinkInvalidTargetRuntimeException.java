 ...
 * <p>What "invalid" means exactly is unspecified. It may be, for instance, that the target was <code>null</code>. 
 */
public class LinkInvalidTargetRuntimeException extends RuntimeException {

	private static final long serialVersionUID = 3688021845631362806L;

	public LinkInvalidTargetRuntimeException() {
	}
