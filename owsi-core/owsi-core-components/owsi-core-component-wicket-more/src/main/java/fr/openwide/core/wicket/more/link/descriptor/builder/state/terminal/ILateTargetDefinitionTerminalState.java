...
public interface ILateTargetDefinitionTerminalState<TPageResult, TResourceResult, TImageResourceResult> {
	 ...
	 * @return The resulting link descriptor or link descriptor mapper for this builder, pointing to the given page.
	 */
	 ...
	 * @return The resulting link descriptor or link descriptor mapper for this builder, pointing to the given resource.
	 */
	...
	/**
	 * @param pageClassModel A model for the class of the page that the resulting link should point to.
	 * @return The resulting link descriptor or link descriptor mapper for this builder, pointing to whatever page
	 * is returned by the given model.
	 */
	TPageResult page(IModel<? extends Class<? extends Page>> pageClassModel);
	
	/**
	 * @param resourceReferenceModel A model for the reference to the resource that the resulting link should point to.
	 * @return The resulting link descriptor or link descriptor mapper for this builder, pointing to whatever resource
	 * reference is returned by the given model.
	 */
