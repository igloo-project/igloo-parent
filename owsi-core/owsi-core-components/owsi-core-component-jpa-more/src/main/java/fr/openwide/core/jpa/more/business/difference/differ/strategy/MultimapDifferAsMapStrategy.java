...
import fr.openwide.core.jpa.more.business.difference.access.MultimapValueByKeyAccessor;

public class MultimapDifferAsMapStrategy<K, V> extends AbstractContainerDifferStrategy<Map<K, Collection<V>>, K> {
