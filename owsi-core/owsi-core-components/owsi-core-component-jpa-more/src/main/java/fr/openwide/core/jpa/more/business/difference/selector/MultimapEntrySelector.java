package fr.openwide.core.jpa.more.business.difference.selector;
...
public class MultimapEntrySelector<K, V> extends ElementSelector implements IKeyAwareSelector<K> {
	...
	public MultimapEntrySelector(Map.Entry<K, V> entry, Equivalence<? super Entry<K, V>> entryEquivalence) {
		this.entry = entry;
	...
	public int hashCode() {
		return new HashCodeBuilder()
				.append(entryEquivalence.hash(entry))
				.build();
	}
