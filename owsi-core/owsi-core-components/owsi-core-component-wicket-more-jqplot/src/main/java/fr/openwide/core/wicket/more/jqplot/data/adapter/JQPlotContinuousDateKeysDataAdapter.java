 ...
 * number of values in any given range), such as dates precise to the second.
 * <p>If your data keys are only "discrete" keys (for example the first day of each week at midnight), use
...
public class JQPlotContinuousDateKeysDataAdapter<S, K extends Date, V extends Number>
	 ...
	 */
	public JQPlotContinuousDateKeysDataAdapter(IModel<Table<S, K, V>> tableModel, String formatString) {
	 ...
	 * (this file is located in the same package as {@link JQPlotDateAxisRendererResourceReference}).
	 */
	public JQPlotContinuousDateKeysDataAdapter(IJQPlotDataProvider<S, K, V> dataProvider, String formatString) {
