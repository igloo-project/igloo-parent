...
public final class NotificationUtils {
	...
	private static final ThreadLocal<Boolean> NOTIFICATIONS_ENABLED = new ThreadLocal<Boolean>() {
		@Override
	...
	/**
	 * Executes a {@link Runnable} with all notifications from all {@link NotificationBuilder}s disabled.
	 */
	...
	/**
	 * Executes a {@link Callable} with all notifications from all {@link NotificationBuilder}s disabled.
