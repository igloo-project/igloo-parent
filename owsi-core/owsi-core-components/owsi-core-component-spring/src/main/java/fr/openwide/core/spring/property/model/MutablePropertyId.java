...
public final class MutablePropertyId<T> extends PropertyId<T> implements IMutablePropertyRegistryKey<T> {

	private static final long serialVersionUID = 7635126176447950686L;

	/**
	 * This constructor is package-protected.
	 * Use {@link AbstractPropertyIds#mutable(String)} for building this type of property ID.
	 */
	...
	/**
	 * This constructor is package-protected.
	 * Use {@link MutablePropertyIdTemplate#create(Object...)} for building this type of property ID from a template.
	 */
