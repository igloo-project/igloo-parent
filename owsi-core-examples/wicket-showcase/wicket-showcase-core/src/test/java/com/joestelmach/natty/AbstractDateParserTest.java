...
public abstract class AbstractDateParserTest {
	...
	/**
	 * Asserts that the given string value parses down to the given month, day,
	 * and year values.
	 * 
	 * @param value
	 * @param month
	...
	/**
	 * 
	 * Asserts that the given string value parses down to the given hours,
	 * minutes, and seconds
	 * 
	 * @param value
	 * @param hours
	 ...
	 * @param seconds
	 */
	protected void validateDateTime(String value, int month, int day, int year, int hours, int minutes, int seconds) {
	 ...
	 * @param seconds
	 */
	protected void validateDateTime(Date date, int month, int day, int year, int hours, int minutes, int seconds) {
