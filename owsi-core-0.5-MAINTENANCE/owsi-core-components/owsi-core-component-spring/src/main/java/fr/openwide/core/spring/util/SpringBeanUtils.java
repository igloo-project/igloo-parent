...
/**
 * Ensemble de méthodes utilitaires permettant de cabler certaines manipulations Spring
 * sur les beans.
 */
public final class SpringBeanUtils {

	/**
	 * Retourne un wrapper permettant de manipuler programmatiquement les propriétés du bean
	 * en utilisant les getters et les setters.
	 * 
