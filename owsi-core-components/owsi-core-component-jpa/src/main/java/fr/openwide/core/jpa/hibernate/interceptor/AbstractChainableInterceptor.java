 ...
 * are not supported by ChainedPropertyInterceptor.
 */
public abstract class AbstractChainableInterceptor implements Interceptor {
	...
	@Override
	public final void onCollectionRecreate(Object collection, Serializable key) throws CallbackException {
	}
	...
	@Override
	public final int[] findDirty(Object entity, Serializable id, Object[] currentState, Object[] previousState,
			String[] propertyNames, Type[] types) {
		return null;
	}

	@Override
	public final Object instantiate(String entityName, EntityMode entityMode, Serializable id) throws CallbackException {
		return null;
	}
