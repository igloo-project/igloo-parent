...
public abstract class AbstractSimplePropertyUpdateInterceptor<T> extends AbstractChainableInterceptor {
	...
	protected abstract boolean onChange(T entity, Object[] currentState, Object[] previousState, String[] propertyNames, Type[] types);
