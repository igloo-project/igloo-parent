...
public interface ITwoParameterMapperOneChosenParameterMappingState<InitialState, T1, T2, MT1>
		extends IParameterMapperOneChosenParameterMappingState<InitialState, MT1> {
