...
public class LongIdGenericEntityConverter<E extends GenericEntity<Long, ?>> extends AbstractConverter<E> {
	...
	private Long convertToId(String value, Locale locale) {
		try {
			...
			throw newConversionException(e.getMessage(), value, locale); // NOSONAR : the Wicket API forces us to lose stacktrace
		}
	}
