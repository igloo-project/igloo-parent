	...
	CREATION_DATE {
		...
		public List<SortField> getSortFields(SortOrder sortOrder) {
			return ImmutableList.of(
					SortUtils.luceneStringSortField(this, sortOrder, QueuedTaskHolder.END_DATE_SORT_FIELD_NAME, SortNull.NULL_FIRST),
					SortUtils.luceneStringSortField(this, sortOrder, QueuedTaskHolder.START_DATE_SORT_FIELD_NAME, SortNull.NULL_FIRST),
